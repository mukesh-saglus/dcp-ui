...
(function ($) {
  ...
  if (version.major === '4') {
    Selectpicker.DEFAULTS.style = 'btn-light select-btn-style cursor rounded-0';
    Selectpicker.DEFAULTS.iconBase = '';
    Selectpicker.DEFAULTS.tickIcon = 'icon-tick';
  }
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '<div class="bs-searchbox bs-searchbox-field">' +
	...
	'</div>' +	 '</div>' +	
      ...
      var drop =
          ...
          searchbox +
          actionsbox +
          '<div class="inner ' + classNames.SHOW + ' scroll-theme" role="listbox" aria-expanded="false" tabindex="-1">' +
