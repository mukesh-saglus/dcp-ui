...
<div class="top-bar-layout">
    ...
    <div class="col-xs-2 text-right padding0 dropdown">
   <a href="javascript:" class="text-color dropdown-toggle share-icon" id="sharebtn" data-toggle="dropdown"><i class="icon-share md17 sm15 xs14" aria-hidden="true"></i></a>
...
<div class="ceneter-play-btn  bg4 playpause" onclick="playVideo()">
	<!--<a href="javascript:" class="md26 sm24 xsem20 text-color"><i class="icon-play"></i></a>-->
...
<div id="player-control" class="bg4 text-color">
    ...
    <div class="center-control clearfix">
      ...
      <div class="seek_slide PlayBar">
        <input id="progress-bar" data-slider-id='ex1Slider' type="text" data-slider-min="0"        data-slider-max="100" data-slider-value="25" data-slider-tooltip="hide"  />
      ...
      <ul id="video-control-right">
        <li class="mt2 Volume"> <a href="javascript:" class="text-color" id="volumebtn"><i class="icon-volume md17 sm15 xs14" aria-hidden="true"></i></a>
          <div id="volumediv" class="managesection">
            <input id="Volume-bar"  data-slider-id='ex2Slider' type="text" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="35"  data-slider-tooltip="hide" data-slider-orientation="vertical"  />
          </div>
        </li>
        ...
        <li class="dropdown setting-dropdown"> <a href="javascript:" class="text-color dropdown-toggle" id="settingbtn"><i class="icon-setting md17 sm15 xs14" aria-hidden="true"></i></a>
         ...
         <li><a href="#"><i class="icon-fulls md17 sm15 xs14"></i></a></li>
		  <li class="abloop-iconmargin"><a href="javascript:"><i class="icon-ab-loop md23 sm21 xs18" aria-hidden="true"></i></a></li>
      </ul>
    </div>
...
<script src="player2/js/script.js"></script> 
