...
<link rel="stylesheet" type="text/css" href="player4-v1/css/icomoon.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<link rel="stylesheet" type="text/css" href="common/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="player4-v1/css/player-theme.css">
<link rel="stylesheet" href="player4-v1/css/bootstrap-slider.css">
<script type='text/javascript' src="common/js/bootstrap-slider.js"></script>
<script type='text/javascript' src="player4-v1/js/script.js"></script>
...
<style type="text/css">
.poster {
	background-image: url("player4-v1/images/poster.jpg");
...
<div class="bottom-bar-layout">
	...
	<!-- saglus logo Div -->
	<div class="saglus-logo"> <img src="common/images/logo.png" class="img-responsive" /> </div>
	<!-- saglus logo Div End -->
    ...
    <div class="right-control clearfix">
      <ul id="video-control-right">
        ...
        <li><a href="#" class="em18 smem14 xsem9 w600">HD</a></li>
		 <li class="abloop-iconmargin"><a href="javascript:"><i class="icon-ab-loop mdem21 smem18 xsem12" aria-hidden="true"></i></a></li> 
      </ul>
    </div>
  </div>
</div>
