...
<!-- Ab Loop Slider End -->		
  ...
  <div id="player-control" class="bg4 text-color">
    ...
    <div class="center-control clearfix">
      <div class="player-time-left hidden-mobile md15 sm15 xs14 w400 timer"> <span id="current-time">0:00</span> </div>
      <div class="seek_slide PlayBar">
      ...
      <div class="player-time-right hidden-mobile md15 sm15 xs14 w400 timer"> <span id="duration-time">0:00</span> </div>
    </div>
      ...
      <ul id="video-control-right">
        <li class="mt2 Volume"><a href="javascript:" class="text-color" id="volumebtn"><i class="icon-volume md17 sm15 xs14" aria-hidden="true"></i></a>
          <div id="volumediv" class="managesection">
            <input id="Volume-bar"  data-slider-id='ex2Slider' type="text" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="0" data-slider-orientation="vertical"  data-slider-tooltip="hide" />
          </div>
        </li>
...
<div class="gate-bar" style="display:none;">
	...
	<iframe src="player3.php" frameborder="0" id="gateframe" style="width: 100%;height: 100%;"></iframe>
</div>
<!---- Gate Bar End---->
...
<script src="player3/js/script.js"></script> 
