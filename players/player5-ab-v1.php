...
<link rel="stylesheet" type="text/css" href="player5-v1/css/icomoon.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
<link rel="stylesheet" type="text/css" href="common/css/bootstrap.min.css">
<link rel="stylesheet" href="player5-v1/css/bootstrap-slider.css">
<script type='text/javascript' src="common/js/bootstrap-slider.js"></script>
<script type='text/javascript' src="common/js/bootstrap.min.js"></script>
<link rel="stylesheet" type="text/css" href="player5-v1/css/player-theme.css">
<!------------ poster background css start -------------->
<style type="text/css">
.poster {
	/*background-image:url(common/images/black.jpg);*/
	background-image: url(player5-v1/images/poster.jpg);
}
</style>
...
<script src="player5-v1/js/script.js"></script> 
