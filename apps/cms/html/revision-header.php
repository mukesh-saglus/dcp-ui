...
<div class="blog-header py5 px15 px-md30">
	<div class="d-flex justify-content-between flex-wrap white-clr">
		<div class="f-14 align-self-center">
			<a href="#" class="t-decoration-none white-clr"><i class="icon-back"></i>&nbsp;&nbsp;Revision history</a>
			</div>
		<div>
			<a href="#" class="base-btn green-btn f-14 restore-detail px-md40">Restore</a>
		</div>
	</div>
</div>
