...
<div class="container-fluid p15 px-md30 py-md30">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-12">
			...
			<p class="f-14 gblue-clr">You can see posts here</p>
		</div>
					...
					<div class="col-12 col-md-12 col-lg-6 col-xl-7">
						<div class="d-flex justify-content-start flex-wrap flex-md-nowrap">
							...
							<div>
								...
								<p class="-f-14 lh140 d-gblue-clr mt5 mb15">Created on Nov 18, 2017 at 4:08 PM </p>
						...
						<div class="row">
							...
							<div class="col-12 text-md-right mt15">
								<ul class="list-inline w400 mb0">
									...
									<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="Preview"><i class="icon-show"></i>&nbsp;  Preview</a>
									</li>
