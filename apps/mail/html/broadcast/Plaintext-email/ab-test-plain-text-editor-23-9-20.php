...
<header class="mail-editor-header">
	<ul class="mail-header-icons f-14">
		...
		<li>
		<div class="dropdown plaintext-editor-dropdown">
			<a class="dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			A Variant</a>
				<ul class="dropdown-menu p0 m0" aria-labelledby="dropdownMenu1">
					<li><a class="dropdown-item" href="#">A Variant</a></li>
					<li><a class="dropdown-item" href="#">B Variant</a> 
					<a href="#" class="pr0"><i class="icon-edit f-12"></i></a>
					<a href="" data-toggle="modal" data-target="#deleteModal"><i class="icon-delete f-12"></i></a></li>
					<li><a class="dropdown-item" href="#">C Variant</a> 
					<a href="#" class="pr0"><i class="icon-edit f-12"></i></a>
					<a href="" data-toggle="modal" data-target="#deleteModal"><i class="icon-delete f-12"></i></a></li>
					<li><a class="dropdown-item" href="#">Choose Variant </a></li>
				</ul>
		</div>
		</li>
