   ...
   <div class="row">
      <div class="col-md-4 col-lg-3 col-xl-2">
         <div class="nav flex-column nav-pills ui-vertical-tab f-16 w400 side-tab-fixed">
            ...
            <a class="nav-link active" href="5-create-newsletter-your-own-design.php"><i class="icon-create-your-own"></i>Create From Scratch</a>
         </div>
      </div>
      <div class="col-md-8 col-lg-9 col-xl-10 mt15 mt-md0">
         <div class="l-gblue-border p15 p-md50">
            ...
            <div class="text-center mt15 mt-md40">
               <a href="#" class="base-btn blue-btn f-16">Create From Scratch</a>
            </div>
         </div>
      </div>
   </div>
