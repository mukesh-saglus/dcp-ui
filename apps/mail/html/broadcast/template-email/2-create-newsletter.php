...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		<div class="col-12 col-md-7 col-lg-7">
			<span class="f-20 f-md-24 lato-font">Broadcasts</span> &nbsp;
			<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
			<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#vhelpModal"><i class="icon-video-help"></i></a>
			<p class="f-14 mt5 gblue-clr">Here you can create & manage your all broadcasts</p>
		</div>
		<div class="col-12 col-md-5 col-lg-5 text-center text-md-right f-16 w400 mt10 mt-md0">
			<a href="#!" data-toggle="modal" data-target="#createbroadcastModal" class="base-btn blue-btn"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Broadcast</a>
		</div>
	...
	<div class="row mb15 mb-md30 min-h-40 relative">
		...
		<div class="table-option-manage pt2 manage animated fadeIn ml-md10 col-12">
		...
		<div class="col-md-12 col-lg-5 col-xl-6 pr-md0 align-items-center mb-lg0 mb15">
			...
			<span class="bs-h40 table-option-hide col-12 col-md-4 col-lg-4 px0 px-md15 mt15 mt-md0">
				<select class="selectpicker f-14" title="All Broadcast (500)">
				  <option>All Broadcast (500)</option>
			...
			<span class="bs-h40 table-option-hide col-12 col-md-3 col-lg-3 pl0 pl-md0 px0 px-md15 mt15 mt-md0">
			...
			<span class="bs-h40 table-option-hide col-12 col-md-3 col-lg-3 pl0 pl-md0 px0 px-md15 pr-md0 mt15 mt-md0">
				<select class="selectpicker f-14">
					<option>Broadcast</option>
					<option>Autoresponder</option>
				</select>
			</span>
            </div>
		</div>
							...
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									<div class="d-flex align-items-center">
									   <div class="f-20 f-md-24 w400 text-ellipsis">New Year Discount offer</div><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-16"></i></a>
									</div>
									<p class="f-14 lh140 d-gblue-clr my15 my-md20">Created on Nov 18, 2017 at 4:08 PM</p>
									<span class="f-12 live-btn mr5 d-inline-flex align-items-center"><i class="icon-pending f-13"></i>&nbsp; In Process</span>
								...
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
										...
										<div class="col-12 text-md-right p0 align-self-end">
											<ul class="list-inline w400 mt-xl20 mb0">
												<li class="list-inline-item mt10 d-none"><a href="#" class="base-btn default-btn btn-h30 f-14" title="Pause"><i class="icon-paused f-12"></i><span class="hide-text-md">&nbsp;  Pause</span></a>
												</li>
												...
												<li class="list-inline-item mt10 d-none"><a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" class="base-btn default-btn btn-h30 f-14" title="Delete"><i class="icon-delete"></i><span class="hide-text-md">&nbsp;  Delete</span></a>
												</li>
						...
						<div class="col-12 col-md-8 col-lg-9 col-xl-9 mt15 mt-md0 d-flex flex-wrap">
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									...
									<span class="f-12 live-btn mr5 d-inline-flex align-items-center"><i class="icon-dot-tick f-13"></i>&nbsp; Completed</span>
						...
						<div class="col-12 col-md-8 col-lg-9 col-xl-9 mt15 mt-md0 d-flex flex-wrap">
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									...
									<span class="f-12 live-btn mr5 d-inline-flex align-items-center"><i class="icon-paused f-12"></i>&nbsp; paused</span>
						...
						<div class="col-12 col-md-8 col-lg-9 col-xl-9 mt15 mt-md0 d-flex flex-wrap">
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									...
									<span class="f-12 live-btn mr5 d-inline-flex align-items-center"><i class="icon-others f-13"></i>&nbsp; Draft</span>
					...
					<div class="row">
						...
						<div class="col-12 col-md-8 col-lg-9 col-xl-9 mt15 mt-md0 d-flex flex-wrap">
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									<div class="d-flex align-items-center">
									   <div class="f-20 f-md-24 w400 text-ellipsis">Weekly design inspiration</div><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-16"></i></a>
									</div>
									<p class="f-14 lh140 d-gblue-clr my15 my-md20">Created on Nov 18, 2017 at 4:08 PM</p>
									
									<span class="f-12 live-btn mr5 d-inline-flex align-items-center"><i class="icon-mail-scheduled f-13"></i>&nbsp; Scheduled : May 06, 2018 </span>
