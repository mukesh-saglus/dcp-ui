...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		<div class="col-12 col-md-7 col-lg-7">
			<span class="f-20 f-md-24 lato-font">A/B Test </span> &nbsp;
			<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
			<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#vhelpModal"><i class="icon-video-help"></i></a>
			<p class="f-14 mt5 gblue-clr">Here you can create & manage your A/B tests</p>
		</div>
		<div class="col-12 col-md-5 col-lg-5 text-center text-md-right f-16 w400 mt10 mt-md0">
			<a href="javascript:void(0)" data-toggle="modal" data-target="#mailaddnewabTestModal" class="base-btn blue-btn"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New A/B Test</a>
		</div>
	</div>
	<!------- Header End ----------->
	<!--- Filteration Div ---->
	<div class="row mb15 mb-md30 relative min-h-40">
		...
		<div class="col-md-4 col-lg-5 col-xl-5 align-items-center mb-md0 mb15">
			<div class="d-flex flex-wrap">
				...
				<span class="bs-h40 table-option-hide col-12 col-md-8 col-lg-8 px0 px-md15 mt15 mt-md0">
					<select class="selectpicker f-14" title="All A/B test (500)">
					  <option>All A/B test (500)</option>
					  <option>Recently added A/B test (10)</option>
					  <option>Recently modified A/B test (15)</option>
					  <option>A/B test added in last 07 days (10)</option>
					  <option>A/B test in last 30 days (10)</option>
					</select>
				</span>
			 </div>   
		</div>
		<div class="col-md-8 col-lg-7 col-xl-7 smart-form table-option-hide">
			<div class="row">
				<div class="col-md-4 col-lg-4 col-xl-4 bs-h40 mb15 mb-md0 pl-md0 text-md-right">
				...
				<div class="col-md-4 col-lg-5 col-xl-5 mb15 mb-md0">
							...
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									<div class="d-flex align-items-center">
									   <div class="f-20 f-md-24 w400 text-ellipsis">New Year Discount offer</div>
                                   ...
                                   <p class="lh150"> Type : Subject</p>
									<p class="lh150">Start Date Nov 18, 2017 at 4:08 PM</p></div>
									<span class="f-12 live-btn"><i class="icon-pending"></i> 
                                   &nbsp; In Process</span>
								...
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
									<div class="d-flex justify-content-between flex-wrap w-100">
										<div class="d-flex mr15 mr-md20">
											<img class="img-fluid d-block mx-auto icon-width" src="<?php echo $basedir; ?>images/contact-icon.png">
											<div class="ml10">
												<span class="f-16">Contact</span>
												<div class="f-24">5000 </div>
											</div>
										</div>
										<div class="d-flex mr15 mr-md20">
									...
									<div class="col-12 text-md-right p0 align-self-end">
										<ul class="list-inline w400 mb0">
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="Pause"><i class="icon-paused f-12"></i><span class="hide-text-md">&nbsp;  Pause</span></a>
											</li>
											...
											<li class="list-inline-item mt10"><a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" class="base-btn default-btn btn-h30 f-14" title="Delete"><i class="icon-delete"></i><span class="hide-text-md">&nbsp;  Delete</span></a>
											</li>
										</ul>
									</div>
								</div>
					...
					<div class="row">
						<div class="col-12 col-md-4 col-lg-3 col-xl-3">
						  <div class="media">
							 ...
							 <div class="media-body ml5">
								<div class="hover-img d-flex align-items-center">
								   <img src="<?php echo $basedir; ?>images/paintexteditor-image.jpg" class="img-fluid d-block mx-auto">
								</div>
							 </div>
						  </div>
					   </div>
						<div class="col-12 col-md-8 col-lg-9 col-xl-9 mt15 mt-md0 d-flex flex-wrap">
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									<div class="d-flex align-items-center">
										<div class="f-20 f-md-24 w400 text-ellipsis">Winter Collection is here </div><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-16"></i></a>
									</div>
									<div class="f-14 d-gblue-clr my10 my-md10">
										<p class="lh150"> Type : Content</p>
										<p class="lh150">Start Date Nov 18, 2017 at 4:08 PM</p>
									</div>
									<span class="f-12 live-btn"><i class="icon-dot-tick"></i> 
                                   &nbsp; Completed</span>
								...
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
									...
									<div class="col-12 text-md-right p0 align-self-end">
										<ul class="list-inline w400 mb0">
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="View" data-toggle="modal" data-target="#lightboxTempModal"><i class="icon-show"></i><span class="hide-text-md">&nbsp;  View</span></a>
											</li>
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="View Reports"><i class="icon-report"></i><span class="hide-text-md">&nbsp;  View Reports</span></a>
											</li>
											<li class="list-inline-item mt10"><a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" class="base-btn default-btn btn-h30 f-14" title="Delete"><i class="icon-delete"></i><span class="hide-text-md">&nbsp;  Delete</span></a>
					...
					<div class="row">
						...
						<div class="col-12 col-md-8 col-lg-9 col-xl-9 mt15 mt-md0 d-flex flex-wrap">
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									<div class="d-flex align-items-center">
										<div class="f-20 f-md-24 w400 text-ellipsis">Diwali offer </div><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-16"></i></a></h4>
									</div>
									<div class="f-14 d-gblue-clr my10 my-md10">
										<p class="lh150"> Type : From Name & Email</p>
										<p class="lh150">Start Date Nov 18, 2017 at 4:08 PM</p>
									</div>
									<span class="f-12 live-btn"><i class="icon-paused"></i> 
                                   &nbsp; Paused</span>
								...
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
									...
									<div class="col-12 text-md-right p0 align-self-end">
										<ul class="list-inline w400 mb0">
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="Resume"><i class="icon-next-one f-12"></i><span class="hide-text-md">&nbsp;  Resume</span></a>
											</li>
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="View Reports"><i class="icon-report"></i><span class="hide-text-md">&nbsp;  View Reports</span></a>
											</li>
											<li class="list-inline-item mt10"><a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" class="base-btn default-btn btn-h30 f-14" title="Delete"><i class="icon-delete"></i><span class="hide-text-md">&nbsp;  Delete</span></a>
					...
					<div class="row">
						...
						<div class="col-12 col-md-8 col-lg-9 col-xl-9 mt15 mt-md0 d-flex flex-wrap">
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									<div class="d-flex align-items-center">
										<div class="f-20 f-md-24 w400 text-ellipsis">Diwali offer</div>
										<a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-16"></i></a>
									</div>
									<div class="f-14 d-gblue-clr my10 my-md10">
										<p class="lh150"> Type : Subject</p>
										<p class="lh150">Start Date Nov 18, 2017 at 4:08 PM</p>
									</div>
									<span class="f-12 live-btn"><i class="icon-draft"></i> 
                                   &nbsp; Draft</span>
					...
					<div class="row">
						...
						<div class="col-12 col-md-8 col-lg-9 col-xl-9 mt15 mt-md0 d-flex flex-wrap">
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									<div class="d-flex align-items-center">
										<div class="f-20 f-md-24 w400 text-ellipsis">Diwali offer</div> <a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-16"></i></a>
									</div>
									<div class="f-14 d-gblue-clr my10 my-md10">
										<p class="lh150"> Type : From Name & Email</p>
										<p class="lh150">Start Date Nov 18, 2017 at 4:08 PM</p>
									</div>
									<span class="f-12 live-btn"><i class="icon-mail-scheduled"></i> 
									&nbsp; Scheduled : May 06, 2018 
									</span>
									<div class="mt15 f-14">Project Name : Project 5</div>
								</div>
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
									<div class="d-flex justify-content-between flex-wrap w-100">
										<div class="d-flex mr15 mr-md20">
									...
									<div class="col-12 text-md-right p0 align-self-end">
										<ul class="list-inline w400 mb0">
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="Send Now"><i class="icon-send-mail"></i><span class="hide-text-md">&nbsp;  Send Now</span></a>
											</li>
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="Re-use"><i class="icon-clicked"></i><span class="hide-text-md">&nbsp;  Re-use</span></a>
											</li>
											<li class="list-inline-item mt10"><a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" class="base-btn default-btn btn-h30 f-14" title="Delete"><i class="icon-delete"></i><span class="hide-text-md">&nbsp;  Delete</span></a>
											</li>
										</ul>
      ...
      <div class="filter-scrollbar mCustomScrollbar" data-mcs-theme="inset-3">
		...
		<!-------- And or div ------------>
         ...
         <div class="clearfix filter-divide-bg">
            ...
            <div class="form-group mb0">
               <select class="selectpicker mt5 f-14" title="In process">
		...
		<div class="clearfix filter-divide-bg">
            <div class="d-flex justify-content-between">
               <div class="w-100 mr15 filter-single-width">
                  <select class="selectpicker f-14" title="Select Broadcast">
		...
		<div class="clearfix filter-divide-bg">
            <div class="d-flex justify-content-between">
               <div class="w-100 mr15 filter-single-width">
                  <select class="selectpicker f-14" title="Select A/B Test Type">
                     <option>A/B Test Type</option>
                  </select>
               </div>
               <div class="align-self-center mt4 d-flex justify-content-between">
            	<a href="#" class="f-16 p-blue-clr t-decoration-none"><i class="icon-add-third"></i></a>
            ...
            <div class="form-group mb0">
               <select class="selectpicker mt5 f-14" title="Is equal to">
                  <option>Content Wise</option>
                  <option>From Name & Email</option>
