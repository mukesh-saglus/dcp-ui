			...
			<div id="accordion" class="accordion">
				<div class="card mb-0 f-16">
					<div class="card-header collapsed" data-toggle="collapse" href="#varianta">
					 ...
					 <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Define subject name for variant A" class="pull-right d-gblue-clr segment-info"><i class="icon-information"></i></a> 
					<div id="varianta" class="collapse">
						<div class="card-body">
						<div class="smart-form row">                            
                            <div class="col-md-6 col-12 d-gblue-clr">		
                            	<label for="exampleSelect1" class="f-14">Subject Name <span class="vi-red-clr">*</span></label>
			...
			<div id="accordion" class="accordion">
				<div class="card mb-0 f-16">
					<div class="card-header collapsed" data-toggle="collapse" href="#variantb">
					 ...
					 <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Define subject name for variant B" class="pull-right d-gblue-clr segment-info"><i class="icon-information"></i></a> 
