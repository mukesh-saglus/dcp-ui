...
<div class="container-fluid p15 p-md30">
   ...
   <div class="row mb15 mb-md30">
      <div class="col-12">
         <ul class="stepwizard-style2 400 lato-font f-20 f-md-24">
   ...
   <div class="stepwizard-style3 d-flex justify-content-start flex-wrap mb15 mb-md25">
      ...
      <div class="d-flex justify-content-start flex-wrap mr15 mb5">
         <div class="circle-num"><span>6</span></div>
   ...
   <div class="row">
      <div class="col-md-4 col-lg-3 col-xl-2">
         <div class="nav flex-column nav-pills ui-vertical-tab f-16 w400 side-tab-fixed">
            <a class="nav-link"  href="3-create-abtesting-broadcast.php"><i class="icon-add-new-broadcast f-16"></i>From Broadcast</a>
            <a class="nav-link active"  href="4-create-abtesting-gallery.php"><i class="icon-gallery"></i>From Gallery</a>
            <a class="nav-link"  href="5-create-abtesting-your-creation-designs.php"><i class="icon-your-creation"></i>From My Templates
            </a>
         </div>
      </div>
      <div class="col-md-8 col-lg-9 col-xl-10">
         ...
         <div class="row">
            ...
            <div class="col-12 col-md-4 col-lg-3 mb15 mb-md30">
               <a href="../../broadcast/Plaintext-email/ab-test-plain-text-editor.php" class="design-gallery-grid recent-active-template p15">
               ...
               <div class="d-flex mt10 f-14 w400">
                    Plain Template
               </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3 mb15 mb-md30">
