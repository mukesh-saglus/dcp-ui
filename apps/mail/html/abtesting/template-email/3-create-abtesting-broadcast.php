   ...
   <div class="row">
      <div class="col-md-4 col-lg-3 col-xl-2">
         <div class="nav flex-column nav-pills ui-vertical-tab f-16 w400 side-tab-fixed">
            <a class="nav-link active"  href="3-create-abtesting-broadcast.php"><i class="icon-add-new-broadcast f-16"></i>From Broadcast</a>
            <a class="nav-link"  href="4-create-abtesting-gallery.php"><i class="icon-gallery"></i>From Gallery</a>
