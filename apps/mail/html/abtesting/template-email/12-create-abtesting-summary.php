...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30">
		<div class="col-12">
		<ul class="stepwizard-style2 w400 lato-font f-29 f-md-24">
		...
		<div class="col-12">
			<div class="l-gblue-border radius5 p15 p-md30">
				<div class="row">
					...
					<div class="col-lg-7 offset-lg-1 col-md-8 mt15 mt-md0">
					<div class="col-12 pl10"><p class="f-24 w600">Varient A</p></div>
    ...
    <tr>
      ...
      <td>27 April, 2018</td>
				...
				<div class="row mt-md50 mt15">
					...
					<div class="col-lg-7 offset-lg-1 col-md-8 mt-md0 mt15">
					<div class="col-12 pl10"><p class="f-24 w600">Varient A</p></div>
						<div class="table-responsive mt5">
						<table width="100%" border="0" cellspacing="0" cellpadding="10" class="f-14 w400">
  <tbody>
