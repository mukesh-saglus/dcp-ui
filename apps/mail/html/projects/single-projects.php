...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		<div class="col-12 col-md-7 col-lg-7">
			...
			<p class="gblue-clr f-14 w400 mt5">Here you can manage your project</p>
		</div>
		<div class="col-12 col-md-5 col-lg-5 text-center text-md-right mt10 mt-md0 f-16 w400">
			...
			<a href="javascript:void(0)" class="base-btn blue-btn" data-toggle="modal" data-target="#createbroadcastModal"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Broadcast</a>
		</div>
	</div>
	<!------- Header End ----------->
	...
	<div class="row mb15 mb-md30 min-h-40 relative">
		...
		<div class="col-md-5 col-lg-5 col-xl-6 align-items-center mb-md0 mb15">
        	<div class="d-flex flex-wrap">
				<div class="smart-checkbox-btn checkbox-strong-blue pull-left ml-md30">
					<input id="checkAll" type="checkbox">
					<label for="checkAll"></label>
				</div>
				<span class="bs-h40 table-option-hide col-12 col-md-9 col-lg-9 col-xl-6 px0 px-md15 mt15 mt-md0">
					<select class="selectpicker f-14" title="All Broadcast (500)">
					       <option>All Broadcast (500)</option>
                          <option>Recently added Broadcast (50)</option>
						  <option>Recently modified Broadcast (55)</option>
						  <option>Broadcast added in last 07 days (150)</option>
						  <option>Broadcast added in last 30 days (250)</option>
                    </select>
				</span>
            </div>
		</div>
		<div class="col-md-7 col-lg-7 col-xl-6 smart-form table-option-hide">
			<div class="row">
							...
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									...
									<div class="f-14 d-gblue-clr my10 my-md10">
										<p class="lh150"> Type : Template</p>
										<p class="lh150">Created on : Nov 18, 2017 at 4:08 PM</p>
									</div>
									<span class="f-12 live-btn mr5 d-inline-flex align-items-center"><i class="icon-pending f-13"></i>&nbsp; In Process</span>
									<div class="mt15 f-14">Project Name Goes Here...</div>
								</div>
					   ...
					   <div class="col-12 col-md-8 col-lg-9 col-xl-9 mt15 mt-md0 d-flex flex-wrap">
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									...
									<div class="f-14 d-gblue-clr my10 my-md10">
										<p class="lh150"> Type : Plain Text</p>
										<p class="lh150">Created on : Nov 18, 2017 at 4:08 PM</p>
									</div>
			...
			<div class="border radius5 relative">
			    ...
			    <div class="filter-scrollbar mCustomScrollbar" data-mcs-theme="inset-3">
					...
					<div class="clearfix filter-divide-bg">
						<div class="d-flex justify-content-between">
						   <div class="w-100 mr15 filter-double-width">
							  <select class="selectpicker f-14" title="Select Broadcast Type">
								 <option>Broadcast Type</option>
							  </select>
						   </div>
						   <div class="align-self-center mt4 d-flex justify-content-between">
