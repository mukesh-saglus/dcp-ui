...
<div class="container-fluid p15 p-md30">
	<div class="row align-items-center">
		...
		<div class="col-12 col-md-5 col-lg-6 text-center text-md-right">
              ...
              <div class="col-md-8 offset-md-0 col-lg-8 col-xl-8 offset-xl-1 offset-lg-0">
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-3 col-xl-2 pl-xl0 pr-xl0 mb10 mb-lg0">
                    <button type="button" class="base-btn default-btn btn-block filter-list-open f-14">Add Filter &nbsp;<i class="icon-filter" aria-hidden="true"></i> </button>
                  </div>
              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
					...
					<th>Assosicated Lists &nbsp;<i class="fa fa-sort"></i></th>
                    <th>Name</th>
                    <th>Sent Mail</th>
                    <th>Open Mail</th>
                    <th>Clicked Mail</th>
                ...
                <div class="table-option-manage animated fadeIn">
					...
					<li class="list-inline-item"><a href="#" class="base-btn default-btn btn-h30 f-14" title="Detele" data-toggle="modal" data-target="#deleteModal"><i class="icon-delete"></i> Delete</a></li>
					</ul>
				</div>
                ...
                <tbody>
                  <tr>
                    <td><div class="smart-checkbox-btn checkbox-strong-blue">
					  ...
					  <td><img src="../../../../../images/profile-icon.png" class="img-fluid img-circle"></td>
				  ...
				  <tr>
                    <td><div class="smart-checkbox-btn checkbox-strong-blue">
					  ...
					  <td><span class="caption l-red-bg">K</span></td>
					<td><a href="#" class="p-blue-clr t-decoration-none">sharmaanurag@gmail.com</a></td>
                    <td>50% Off</td>
					<td>N/A</td>
                    <td>1050</td>
