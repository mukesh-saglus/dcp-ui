...
<div class="container-fluid p15 p-md30">
	<div class="row align-items-center">
		...
		<span class="f-md-24 f-20 lato-font">Score Rules </span> &nbsp;
		<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
		<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#vhelpModal"><i class="icon-video-help"></i></a>
		<p class="lightgrey mt5">Here you can create & manage your score rules</p>
		</div>
		<div class="col-12 col-md-5 text-center text-md-right mt10 mt-md0">
		<a href="#" class="base-btn blue-btn" data-toggle="modal" data-target="#AddScorePopup"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Score Rule</a>
		</div>
	</div>
          ...
          <div class="col-12">
           <div class="row">
			<div class="col-md-4 col-lg-4 col-xl-3 bs-h40 mb10 mb-md0">
				<select class="selectpicker f-14" title="All Score Rules (1000)">
				  <option>All Score Rules (1000)</option>
				  <option>Recently added Score Rule (10)</option>
                  <option>Recently modified Score Rule (15)</option>
                  <option>Score Rule added in last 07 days (10)</option>
				  <option>Score Rule added in last 30 days (10)</option>
				</select>
			</div>
					...
					<div class="col-md-8 col-lg-4 offset-lg-4 col-xl-4 offset-xl-6 mb10 mb-md0 pl-md0">
						<div class="smart-search-field">
							<div class="input-group">
								<input class="form-control" placeholder="Search Score Rules by Name" type="text">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><a href="#" class="p-blue-clr t-decoration-none">Active Buyer</a></td>
					<td>100</td>
                    <td>1 Hour</td>
                    <td>
                  ...
                  <tr>
					...
					<td><a href="#" class="p-blue-clr t-decoration-none">Active Buyer</a></td>
                    <td>115</td>
					<td class="vi-red-clr">Expired</td>
                      <td>
					<label class="switchtoggle-btn m-0">
							<input class="switchtoggle-input" type="checkbox" checked>
							<span class="switchtoggle-label" data-on="On" data-off="Off"></span> <span class="switchtoggle-handle"></span>
