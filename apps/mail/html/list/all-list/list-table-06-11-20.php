              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
					<a href="#" class="list-successfully-icon pointer-events-none">
					<span data-toggle="tooltip" data-placement="top" data-original-title="In Progress"><i class="fa fa-spinner fa-pulse grey"></i></span></a>
					</td>
					 ...
					 <li class="action-menu"><a href="#" class="action-item" data-toggle="modal" data-target="#AddContactModal" title="Import Accounts"><i class="icon-import-contactt"></i></a></li>
						...
						<li class="action-menu table-action-dropdown"> <a href="javascript:" class="dropdown-toggle action-item" data-toggle="dropdown">  <span data-toggle="tooltip" data-placement="top"  data-original-title="More"><i class="icon-more"></i></span> </a>
                          <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            <li><a href="#" data-toggle="modal" data-target="#successfullyCleanListModal">List Checking</a></li>
                  ...
                  <tr>
					...
					<td><a href="#" data-toggle="modal" data-target="#ContactsReviewModal"  class="list-successfully-icon">
					<span data-toggle="tooltip" data-placement="top" data-original-title="Successful"><i class="icon-tick s-green-clr"></i></span></a>
					</td>
					<td><a href="#" class="p-blue-clr t-decoration-none">Demo List 1</a></td>
                    <td>10 Dec 2017</td>
                    <td>1000</td>
                  ...
                  <tr>
					...
					<td><a href="#" data-toggle="modal" data-target="#ContactsReviewdeniedModal"  class="list-successfully-icon">
					<span data-toggle="tooltip" data-placement="top" data-original-title="Denied"><i class="icon-cross vi-red-clr"></i></span></a>
					</td>
					<td><a href="#" class="p-blue-clr t-decoration-none">Demo List 1</a></td>
                    <td>10 Dec 2017</td>
					<td>1000</td>
