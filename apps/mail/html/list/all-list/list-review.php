...
<div class="container-fluid p15 p-md30">
   <div class="row align-items-center">
      <div class="col-12">
         <span class="f-20 f-md-24 lato-font">List Review </span> &nbsp;
         <a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
         <a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#vhelpModal"><i class="icon-video-help"></i></a>
         <p class="d-gblue-clr w400 mt5">Here you can review customer’s contacts</p>
      </div>
   </div>
      ...
      <div class="col-12">
         <div class="row">
            <div class="col-md-6 col-lg-3 bs-h40 mb10 mb-lg0 smart-form">
               <select class="selectpicker f-14" title="All Reviews (43)">
                  <option>All Reviews (43)</option>
                  <option>Reviews in last 24 hours</option>
                  <option>Reviews in last 7 days</option>
                  <option>Reviews in last 30 days</option>
               </select>
            </div>
            ...
            <table class="table table-bordered">
               <thead>
                  <tr>
                     ...
                     <th>Uploaded On &nbsp;<i class="fa fa-sort"></i></th>
                     <th>Uploaded Contacts &nbsp;<i class="fa fa-sort"></i></th>
                     <th>Actions</th>
                  </tr>
               </thead>
               ...
               <tbody>
                  <tr>
                     ...
                     <td>10,000</td>
                     <td><a href="#" class="base-btn default-btn-theme btn-h30 mr10" data-toggle="modal" data-target="#ReviewSurveyModal">Survey</a><a href="#" class="base-btn default-btn-theme btn-h30 mr10">Approve</a><a href="#" class="base-btn default-btn-theme btn-h30">Decline</a></td>
                  </tr>
                  <tr>
                     <td>
                        <div class="smart-checkbox-btn checkbox-strong-blue">
