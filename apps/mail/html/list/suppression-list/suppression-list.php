...
<div class="container-fluid p15 p-md30">
	<div class="row align-items-center">
		...
		<span class="f-md-24 f-20 lato-font">Suppression Lists</span> &nbsp;
		<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
		<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#vhelpModal"><i class="icon-video-help"></i></a>
		<p class="lightgrey mt5">Here you can create and manage your suppression lists</p>
		</div>
          ...
          <div class="col-12">
           <div class="row">
			<div class="col-md-4 col-lg-4 col-xl-3 bs-h40 mb10 mb-md0 pr-lg0">
				<select class="selectpicker f-14" title="All Suppression List (1000)">
				  <option>All Suppression List (1000)</option>
				  <option>Recently added Suppression List (10)</option>
                  <option>Recently modified Suppression List (15)</option>
                  <option>Suppression List added in last 07 days (10)</option>
				  <option>Suppression List added in last 30 days (10)</option>
				</select>
			</div>
              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th>Suppression List Name &nbsp;<i class="fa fa-sort"></i></th>
					<th>Created date</th>
                    <th>Contacts</th>
                    <th>Actions</th>
                  </tr>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><a href="#" class="w400 p-blue-clr t-decoration-none">Suppression List 1</a></td>
					<td>01 Jan 2018</td>
                    <td>1000</td>
                    <td><ul class="table-action">
                        <li class="action-menu"><a href="#" class="action-item" data-toggle="modal" data-target="#AddSuppressionListModal" title="Edit"><i class="icon-edit"></i></a></li>
