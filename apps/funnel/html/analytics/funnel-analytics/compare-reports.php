	...
	<div class="row">
		...
		<div class="col-12 col-md-4 col-lg-4">
			<div class="vl-gblue-bg p15 p-md30 radius5">
				<label for="exampleSelect1" class="gblue-clr f-16 w400">Choose Funnels</label>
		...
		<div class="col-12 col-md-1 col-lg-1  align-self-center p15"><img src="<?php echo $basedir; ?>images/vs-icon.png" class="img-fluid d-block mx-auto">
		</div>
		<div class="col-12 col-md-4 col-lg-4">
			<div class="vl-gblue-bg p15 p-md30 radius5">
				<label for="exampleSelect1" class="gblue-clr f-16 w400">Choose Funnels</label>
