...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		<div class="col-12 col-md-6 col-lg-7">
			...
			<p class="f-14 gblue-clr w400">Here you are manage your all funnel</p>
		</div>
		<div class="col-12 col-md-6 col-lg-5 text-center text-md-right f-16 w400">
			...
			<a href="javascript:" class="base-btn blue-btn mt10 mt-md0" data-toggle="modal" data-target="#createNewFunnelModal" ><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New funnel</a>
		</div>
	...
	<div class="row mb15 mb-md30 min-h-40 relative">
		...
		<div class="col-md-12 col-lg-5 col-xl-6 pr-md0">
			<div class="d-flex flex-wrap bs-h40">
				<div class="smart-checkbox-btn checkbox-strong-blue pull-left ml-md30">
					<input id="checkAll" type="checkbox">
					<label for="checkAll"></label>
				</div>
				
				<span class="col-12 col-md-6 col-lg-6 col-xl-6 mt15 mt-md0 px0 px-md15 table-option-hide">
					<select class="selectpicker f-14" title="All funnel (400)">
					  <option>All funnel (400)</option>
					  <option>Recently added funnel (10)</option>
					  <option>Recently modified funnel (15)</option>
					  <option>funnel added in last 07 days (10)</option>
					  <option>funnel added in last 30 days (10)</option>
					</select>
				</span>
		...
		<div class="col-md-12 col-lg-7 col-xl-6 smart-form table-option-hide mt15 mt-lg0">
			<div class="row">
										...
										<ul class="list-inline w400 mt-xl20 mb0">
											...
											<li class="list-inline-item mt10 dropdown simple-dropdown caret-icon-none">
												...
												<ul class="dropdown-menu dropdown-menu-right mCustomScrollbar f-14" data-mcs-theme="inset-3" aria-labelledby="dropdownMenu1">
												    <li> <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#CopytoBusinessModal">Copy to Other Business </a>
													</li>
													<li> <a class="dropdown-item" href="javascript:void(0)">Download Funnel</a>
													</li>
								...
								<div class="col-xl-7 col-lg-6 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
									...
									<div class="col-12 text-md-right p0 align-self-end">
										<ul class="list-inline w400 mt-xl20 mb0">
											...
											<li class="list-inline-item mt10"><a href="javascript:void(0);" class="base-btn default-btn btn-h30 f-14 template-preview" title="Preview"><i class="icon-show"></i><span class="hide-text-md">&nbsp;  Preview</span></a>
											</li>
											<li class="list-inline-item mt10 dropdown simple-dropdown caret-icon-none">
												<a href="#" class="base-btn default-btn btn-h30 f-14 dropdown-toggle" data-toggle="dropdown">
													<span data-toggle="tooltip" data-placement="top" title="" data-original-title="More"><i class=" icon-more"></i></span>
