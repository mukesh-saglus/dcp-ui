...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30">
		<div class="col-12">
			...
			<p class="f-14 w400 gblue-clr">Here you are manage your all notification</p>
		</div>
	</div>
	<!------- Header End ----------->
	...
	<div class="row">
			...
			<div id="accordion" class="accordion">
				<div class="card mb-0 f-16">
					<div class="card-header collapsed" data-toggle="collapse" href="#collapseurl">
					 ...
					 <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Choose this option if you want to Publish & Activate this A/B test page on a URL." class="pull-right d-gblue-clr segment-info"><i class="icon-information"></i></a> 
						...
						<div class="card-body">
							<div class="smart-form puplish-form row">
								<div class="col-md-11 col-12">
									<div class="row">
										<div class="col-12 col-md-7 col-lg-9">
											<div class="d-flex">
												...
												<!-- Lock Unlock Icon -->
												<!--<a href="javascript:void(0);" class="lock-unlock-icon"><i class="icon-unlock"></i></a>-->
												<a href="javascript:void(0);" class="lock-unlock-icon active"><i class="icon-locked"></i></a>
												
												<div class="w-100">
												
													<div class="input-group">
														<div class="input-group-prepend addon-icon">
														<div class="input-group-text f-15 l-gblue-bg relative">eduncle.saglus.com/
															<span class="front-end-sup-btn front-absolute-btn">Front-end</span>
														</div>
														</div>
														<input type="text" class="form-control rounded-left-0" placeholder="funnel name - page name">
													</div>
													
													<!-- Status Section -->
													<div class="d-flex justify-content-start flex-wrap mt15 mt-md20 mb10 d-gblue-clr ml5">
														<div class="smart-radio-btn radio-strong-blue mr25">
															<input name="chkStatus" id="Public-Select" type="radio">
															<label for="Public-Select">Public</label>
														</div>
														<div class="smart-radio-btn radio-strong-blue">
															<input name="chkStatus" id="select-Protected" type="radio" checked>
															<label for="select-Protected"> Password Protected</label>
														</div>
													</div>
													
													<div class="col-12 col-md-12 col-lg-6 mb10 p0">
														<div class="relative publish-activate-input-field">
															<input class="form-control pr60" id="password-field" placeholder="Password" value="" type="password">
										...
										<div class="col-12 col-md-5 col-lg-3 mt10 mt-md5 text-md-left text-right text-nowrap">
											<button type="submit" class="base-btn blue-btn btn-h40">Copy Link</button>
											<a href="#" class="vl-blue-clr px15 f-14" data-toggle="modal" data-target="#lightboxTempModal"><u>View Page</u></a>
										</div>
									
									</div>
									<div class="row mt15 align-items-center">
										<div class="col-12 col-md-7 col-lg-9">
											<div class="input-group">
												<div class="input-group-prepend addon-icon">
										...
										<div class="col-12 col-md-5 col-lg-3 mt10 mt-md0 text-md-left text-right text-nowrap">
											<button type="submit" class="base-btn blue-btn btn-h40">Copy Link</button>
											<a href="#" class="vl-blue-clr px15 f-14" data-toggle="modal" data-target="#lightboxTempModal"><u>View Page</u></a>
										</div>
									</div>
									...
									<div class="row mt10 mt-md20">
										<div class="col-md-12 col-12 col-lg-12">	
											<p class="f-14 mt10 d-gblue-clr pl-md20 pl0">You have not redirected your sub-domain to your domain,
											<a href="#" class="p-blue-clr"><u>click here</u></a> to redirect the sub-domain to your domain.
											</p>
										</div>
									</div>
								</div>
								<div class="col-12 col-md-1 mt10 mt-md0">
		...
		<div class="col-12 segment-accordion mt-md20 mt15">
			<div id="accordion" class="accordion">
				<div class="card mb-0 f-16">
					<div class="card-header collapsed no-collapsable" data-toggle="collapse" href="#collapseSocialSharing">
						<a class="card-title lato-font">&nbsp; Social Sharing</a>
					</div>
					 <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Select the social accounts where you want to share your A/B test page." class="pull-right d-gblue-clr segment-info"><i class="icon-information"></i></a> 
				...
				<div class="card mb-0 f-16">
					...
					<div id="collapseDownload" class="collapse">
						...
						<div class="d-flex align-items-center flex-wrap">
							<p class="f-14 d-gblue-clr mb-md0 mb10 ml0 mr15  mr-md30">Download Funnels here</p>
			...
			<div id="accordion" class="accordion">
				<div class="card mb-0">
					<div class="card-header collapsed" data-toggle="collapse" href="#collapsePublish">
						<a class="card-title f-16 lato-font">&nbsp; Publish</a>
					</div>
					 <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Choose your A/B test start and end date & time." class="pull-right d-gblue-clr segment-info"><i class="icon-information"></i></a> 
									...
									<div class="d-flex smart-form justify-content-start flex-wrap align-items-center">
										<div class="col-xl-4 col-md-5 col-12 pl0 pr0 pr-md15 caleran-h50 mb10 mb-md0">
											<div class="input-group calendar-input-group">
												...
												<button class="btn calendar-btn grey h50 f-19" type="button"><i class="icon-calendar"></i></button>
												</span>
											</div>
										</div>
