...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		...
		<div class="col-12 col-md-6 col-lg-5 text-center text-md-right mt10 mt-md0 f-16 w400">
			...
			<a href="javascript:" class="base-btn blue-btn" data-toggle="modal" data-target="#createNewFunnelModal" ><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New funnel</a>
		</div>
	...
	<div class="row mb15 mb-md30 min-h-40 relative">
		...
		<div class="col-md-12 col-lg-5 col-xl-6 pr-md0">
			<div class="d-flex flex-wrap bs-h40">
				...
				<span class="col-12 col-md-5 col-lg-4 col-xl-3 mt15 mt-md0 px0 px-md15 table-option-hide ml-lg0 ml-auto">
					<select class="selectpicker f-14" title="funnel">
