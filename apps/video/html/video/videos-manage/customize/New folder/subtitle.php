         ...
         <div class="row">
            <div class="col-12 col-md-12 col-lg-5 order-2 order-lg-1 smart-form mt15 mt-lg0">
               <ul class="nav tabs-style1 nav-justified f-14 f-sm-16 w400 mb15 mb-md25" role="tablist">
                  ...
                  <li class="nav-item">
                     <a class="nav-link active" href="subtitle.php" title="Subtitle">
				...
				<label class="d-gblue-clr">Paste your .srt file here</label>
					<textarea class="form-control" rows="3" placeholder="The data entry box  will have no text here. As the .srt file will be copied here."></textarea>
				</div>
				
				<a href="#" class="p-blue-clr t-decoration-none f-14 w400" data-toggle="modal" data-target="#VideoSubtitleModal">Example</a>
          
               
				
				<div class="col-12 p0 text-right mt15 mt-md30">
