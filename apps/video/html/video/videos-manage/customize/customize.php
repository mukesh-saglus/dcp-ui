            ...
            <div class="col-12 col-md-12 col-lg-5 order-2 order-lg-1 smart-form mt15 mt-lg0">
               ...
               <div class="form-group mb-md20">
                  ...
                  <div class="d-flex align-items-center player-dropdown">
                     <div class="dropdown customplayer-dropdown w-100">
                        <button class="btn base-btn default-btn dropdown-toggle btn-block btn-h50 text-left" type="button" id="dropdownMenu1" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false"> <span class="caret-right pull-left text-truncate pr15">Choose Video Player</span> </button>
                        <div class="dropdown-menu w-100 h-auto f-14"  aria-labelledby="dropdownMenu1">
                           ...
                           <div class="selectplayer-drop f-14" data-mcs-theme="inset-3">
                              <li class="player-item">DotcomPal Players</li>
                              <li class="dropdown-item">
                                 <div class="smart-checkbox-btn checkbox-strong-blue text-truncate player-value">
                                    <input id="Convertstream" type="checkbox">
                                    <label for="Convertstream" title="Convertstream">Convertstream</label>
                                 </div>
                              </li>
                              <li class="dropdown-item">
                                 <div class="smart-checkbox-btn checkbox-strong-blue text-truncate player-value">
                                    <input id="LeadIris" type="checkbox">
                                    <label for="LeadIris" title="LeadIris">LeadIris</label>
                                 </div>
                              </li>
                              <li class="dropdown-item">
                                 <div class="smart-checkbox-btn checkbox-strong-blue text-truncate player-value">
                                    <input id="EyeEngage" type="checkbox">
                                    <label for="EyeEngage" title="EyeEngage">EyeEngage</label>
                                 </div>
                              </li>
                              <li class="dropdown-item">
                                 <div class="smart-checkbox-btn checkbox-strong-blue text-truncate player-value">
                                    <input id="LeadFrame" type="checkbox">
                                    <label for="LeadFrame" title="LeadFrame">LeadFrame</label>
                                 </div>
                              </li>
                              <li class="dropdown-item">
                                 <div class="smart-checkbox-btn checkbox-strong-blue text-truncate player-value">
                                    <input id="StarkMark" type="checkbox">
                                    <label for="StarkMark" title="StarkMark">StarkMark</label>
                                 </div>
                              </li>
                              <li class="dropdown-item">
                                 <div class="smart-checkbox-btn checkbox-strong-blue text-truncate player-value">
                                    <input id="LeadFesto" type="checkbox">
                                    <label for="LeadFesto" title="LeadFesto">LeadFesto</label>
                                 </div>
                              </li>
                              <li class="dropdown-divider"></li>
                              <li class="player-item">Your Custom Players</li>
                              <li class="dropdown-item">
                                 <div class="smart-checkbox-btn checkbox-strong-blue text-truncate player-value player-delete-width">
                                    <input id="CustomPlayerOne" type="checkbox">
                                    <label for="CustomPlayerOne" title="Custom Player One">Custom Player One</label>
                                 </div>
                                 <div class="player-delete"><a href="javascript:void(0)" data-toggle="modal" data-target="#PlayerdeleteModal"><i class="icon-delete"></i></a></div>
                              </li>
                              <li class="dropdown-item">
                                 <div class="smart-checkbox-btn checkbox-strong-blue text-truncate player-value player-delete-width">
                                    <input id="CustomPlayerTwo" type="checkbox">
                                    <label for="CustomPlayerTwo" title="Custom Player Two">Custom Player Two</label>
                                 </div>
                                 <div class="player-delete"><a href="javascript:void(0)" data-toggle="modal" data-target="#PlayerdeleteModal"><i class="icon-delete"></i></a></div>
                              </li>
                              <li class="dropdown-item">
                                 <div class="smart-checkbox-btn checkbox-strong-blue text-truncate player-value player-delete-width">
                                    <input id="CustomPlayerThree" type="checkbox">
                                    <label for="CustomPlayerThree" title="Custom Player Three">Custom Player Three</label>
                                 </div>
                                 <div class="player-delete"><a href="javascript:void(0)" data-toggle="modal" data-target="#PlayerdeleteModal"><i class="icon-delete"></i></a></div>
                              </li>
                           </div>
                  ...
                  <div class="col-12 col-md-8 col-lg-12 col-xl-8">
                     <div id="cp3" class="input-group colorpicker-component align-items-center row">
                        <span class="input-group-addon col-6">
                           <div></div>
                           <i class="w-100 h50 l-gblue-border"></i>
                        </span>
