	...
	<div class="row">
		...
		<div class="col-12 col-md-12 col-lg-6 mb15 mb-lg0">
          ...
          <li> <a href="#">Top 10 Countries </a> </li>
			...
			<p class="f-14 lh140 d-gblue-clr w400">Top countries from where your videos get most traffic & conversions</p>
		</div>
		...
		<div class="col-12 col-md-12 col-lg-4 mt20 mt-lg10">
			...
			<div class="row small-radio-btn">
				...
				<div class="smart-radio-btn text-truncate  radio-strong-yellow col-md-6 col-12">
					...
					<label for="UniqueAudience" onclick="updatePieChart('conversionpie')">Conversions</label>	
				</div>
				<div class="smart-radio-btn text-truncate radio-strong-green col-md-6 col-12">
					...
					<label class="mb-lg20" for="Conversion" onclick="updatePieChart('conversionratepie')">Plays</label>
				...
				<div class="smart-radio-btn text-truncate radio-strong-purple col-md-6 col-12">
					...
					<label for="ConversionRate" onclick="updatePieChart('uaudiencepie')">Engagement Rate</label>
				</div>
			</div>
			<!--- Chart -->
