...
<!------- Conversion Graph (Lead) Section Start----------->
	...
	<div class="row">
		...
		<div class="col-12 col-md-8 col-lg-9 mb15 mb-md0">
			...
			<p class="f-14 lh140 d-gblue-clr w400">View conversion graph for the lead ads embedded on videos</p>
		</div>
...
<!------- Conversion Graph (Promo) Section Start----------->
	...
	<div class="row">
		...
		<div class="col-12 col-md-8 col-lg-9 mb15 mb-md0">
			...
			<p class="f-14 lh140 d-gblue-clr w400">View conversion graph for the promo ads embedded on videos</p>
		</div>
		<div class="col-12 col-md-4 col-lg-3 bs-h40 f-16 align-self-center d-flex justify-content-between dropdown caret-icon-none simple-dropdown show-submenu">
		<!----- Graph Type icon section------->	
			<a href="#" class="align-self-center dropdown-toggle d-gblue-clr t-decoration-none" id="dropdownMenuDivider" data-toggle="dropdown"><i class="icon-more"></i> &nbsp;</a>
...
<!------- Conversion Graph (Share) Section Start----------->
	...
	<div class="row">
		...
		<div class="col-12 col-md-8 col-lg-9 mb15 mb-md0">
			...
			<p class="f-14 lh140 d-gblue-clr w400">View conversion graph for the share ads embedded on videos</p>
		</div>
		<div class="col-12 col-md-4 col-lg-3 bs-h40 f-16 align-self-center d-flex justify-content-between dropdown caret-icon-none simple-dropdown show-submenu">
		<!----- Graph Type icon section------->	
			<a href="#" class="align-self-center dropdown-toggle d-gblue-clr t-decoration-none" id="dropdownMenuDivider" data-toggle="dropdown"><i class="icon-more"></i> &nbsp;</a>
...
<!------- Conversion Rate Graph Section Start----------->
	...
	<div class="row">
		...
		<div class="col-12 col-md-8 col-lg-9 mb15 mb-md0">
			...
			<p class="f-14 lh140 d-gblue-clr w400">View conversion rate graph for the videos</p>
		</div>
		<div class="col-12 col-md-4 col-lg-3 bs-h40 f-16 align-self-center d-flex justify-content-between dropdown caret-icon-none simple-dropdown show-submenu">
		<!----- Graph Type icon section------->	
			<a href="#" class="align-self-center dropdown-toggle d-gblue-clr t-decoration-none" id="dropdownMenuDivider" data-toggle="dropdown"><i class="icon-more"></i> &nbsp;</a>
...
<!------- Engegement Graph Section Start----------->
	<div class="col-12 p0 mt15 mt-md80">
	<div class="row">
		<!------ Title Header-------------->
		<div class="col-12 col-md-8 col-lg-9 mb15 mb-md0">
			<h4>Engagement Graph</h4>
			<p class="f-14 lh140 d-gblue-clr w400">View engagement for the videos</p>
		</div>
		<div class="col-12 col-md-4 col-lg-3 bs-h40 f-16 align-self-center d-flex justify-content-between dropdown caret-icon-none simple-dropdown show-submenu">
		<!----- Graph Type icon section------->	
			<a href="#" class="align-self-center dropdown-toggle d-gblue-clr t-decoration-none" id="dropdownMenuDivider" data-toggle="dropdown"><i class="icon-more"></i> &nbsp;</a>
	   ...
	   <div class="p15 p-md20">
		   <div class="f-14 f-md-16 w400 d-gblue-clr mb15">View As</div>
			<ul class="nav tabs-style2 f-14" role="tablist">
			  <li class="nav-item"> <a class="nav-link active" data-toggle="tab" data-target="#lineengegement">&nbsp; Line &nbsp;</a> </li>
			  <li class="nav-item"> <a class="nav-link" data-toggle="tab" data-target="#barengegement">&nbsp; Bar &nbsp;</a> </li>
			  <li class="nav-item"> <a class="nav-link show" data-toggle="tab" data-target="#tableengegement">&nbsp; Table &nbsp;</a> </li>
			</ul>
			</div>
   		</div>
			
		<!----- Select Date Selectpicker------->
			<div class="col-8 p0 smart-form">
       <input type="text" class="caleran-ex-1 field-h40 form-control" readonly  data-plugin-options='{"rangeOrientation":true,"showButtons":true}' /></div>
			<!----- refresh Icon------->	
			<span class="align-self-center">
				<a href="#" class="d-gblue-clr t-decoration-none">
	...
	<div class="row mt15 mt-md30">
		<div class="col-12 engagementgraph">
		<div class="tab-content">
          <div id="lineengegement" class="tab-pane active">
             <div id="engagementgraph">
            <svg></svg>
            </div>
          </div>
          <div id="barengegement" class="tab-pane fade">
             <div id="engagementgraphbar">
            <svg></svg>
            </div>
          </div>
          <div id="tableengegement" class="tab-pane fade">
              <div id="thori-scroll" class="table-responsive smart-table-style">
              <table class="table table-bordered">
                <thead>
                  <tr>
...
<!------- Heatmap Graph Section Start----------->
	<div class="col-12 p0 mt15 mt-md80">
	<div class="row">
		<!------ Title Header-------------->
		<div class="col-12 col-md-8 col-lg-9 mb15 mb-md0">
			<h4>Heatmap Graph</h4>
			<p class="f-14 lh140 d-gblue-clr w400">Discover where your visitors are getting more engaged on your videos.</p>
		</div>
		<div class="col-12 col-md-4 col-lg-3 bs-h40 f-16 align-self-center d-flex justify-content-between dropdown caret-icon-none simple-dropdown show-submenu">
		<!----- Select Date Selectpicker------->
		<div class="col-10 p0 smart-form">
       <input type="text" class="caleran-ex-1 field-h40 form-control" readonly  data-plugin-options='{"rangeOrientation":true,"showButtons":true}' /></div>
		<!----- refresh Icon------->	
		<span class="align-self-center">
			<a href="#" class="d-gblue-clr t-decoration-none">
	...
	<div class="row mt15 mt-md30">
		<div class="heatmapgraph col-12">
			<div class="relative pl60">
				<div class="relative d-inline-block bottom-50 mt50 mw100-20">
					<img src="<?php echo $basedir; ?>images/video-capture-img.png" class="img-fluid heatmap-height">
					<!----- Video Capture Overlay----->
					<div class="video-capture-overlay"></div>
				</div>
				<!-------- Heatmap Line Graph------->
