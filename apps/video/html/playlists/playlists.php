...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		<div class="col-12 col-md-7 col-lg-7">
			<span class="f-20 f-md-24 lato-font">All Playlists</span> &nbsp;
			<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
			<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#vhelpModal"><i class="icon-video-help"></i></a>
			<p class="f-14 mt5 gblue-clr">Create, manage & preview all viral pages here.</p>
		</div>
		<div class="col-12 col-md-5 col-lg-5 text-center text-md-right mt10 mt-md0 f-16 w400">
			<a href="javascript:void(0)" data-toggle="modal" data-target="#AddNewPlaylistModal" class="base-btn blue-btn"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Playlist</a>
		</div>
	...
	<div class="row mb15 mb-md30 relative min-h-40">
		...
		<div class="col-md-4 col-lg-5 col-xl-6 pr-md0 align-items-center mb-lg0 mb15">
			<div class="d-flex flex-wrap">
				...
				<span class="bs-h40 table-option-hide col-12 col-md-9 col-xl-6 px0 px-md15 pr-md0 mt15 mt-md0">
		...
		<div class="col-md-8 col-lg-7 col-xl-6 smart-form table-option-hide">
			<div class="row">
							...
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
									<div class="d-flex align-items-center">
										<div class="f-20 f-md-24 w400 text-ellipsis">Playlist Name</div>
										<div class=""><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-16"></i></a></div>
									</div>
									<p class="f-14 lh140 d-gblue-clr my15 my-md20">Total Videos : 10 <br>
									Created on Nov 18, 2017 at 4:08 PM
									</p>
								</div>
								<div class="col-xl-6 col-lg-6 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
									...
									<div class="col-12 text-md-right p0 align-self-end">
										<ul class="list-inline w400 mb0">
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="Add Videos"><i class="icon-add-new"></i><span class="hide-text-md">&nbsp;  Add Videos</span></a>
											</li>
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="View Videos"><i class="icon-show"></i><span class="hide-text-md">&nbsp;  View Videos</span></a>
											</li>
											<li class="list-inline-item mt10"><a href="javascript:;" class="base-btn default-btn btn-h30 f-14" title="View"><i class="icon-preview"></i><span class="hide-text-md">&nbsp;  View</span></a>
											</li>
				...
				<div class="filter-scrollbar mCustomScrollbar" data-mcs-theme="inset-3">
					<div class="clearfix filter-divide-bg">
						<div class="d-flex justify-content-between">
							<div class="w-100 mr15 filter-single-width">
								<select class="selectpicker f-14" title="Select Playlist Name">
									<option>Playlist Name</option>
								</select>
							</div>
							<div class="align-self-center mt4 d-flex justify-content-between">
						...
						<div class="form-group mb0 smart-form f-14">
							<input type="text" class="form-control border-top-0" placeholder="Enter Playlist Name">
						</div>
					</div>
				</div>
				<!-------- And or div ------------>
