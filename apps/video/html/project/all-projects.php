...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		...
		<div class="col-12 col-md-5 col-lg-5 text-center text-md-right mt10 mt-md0 f-16 w400">
			...
			<a href="javascript:void(0)" data-toggle="modal" data-target="#createNewVideoModal" class="base-btn blue-btn"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Project</a>
		</div>
	...
	<div class="row mb15 mb-md30 relative min-h-40">
		...
		<div class="table-option-manage manage animated fadeIn ml-md10 ml0 col-12 pt2">
			<ul class="list-inline f-14 w400 mb0">
				...
				<a href="#" class="base-btn default-btn btn-h30 f-14" title="Merge" data-toggle="modal" data-target="#MergeModal"><i class="icon-merge"></i><span class="d-none d-md-inline-block">&nbsp;  Merge</span></a>
				</li>
				<li class="list-inline-item mb10 mb-lg0"><a href="javascript:void(0)" class="base-btn default-btn btn-h30 f-14" title="Compare"><i class="icon-compare"></i><span class="d-none d-md-inline-block">&nbsp;  Compare</span></a>
				</li>
		...
		<div class="col-md-5 col-lg-5 col-xl-5 align-items-center mb-md0 mb15">
			...
			<span class="bs-h40 table-option-hide col-12 col-12 col-md-9 col-lg-8 col-xl-7 px0 px-md15 mt15 mt-md0">
                        ...
                        <div class="hover-img d-flex align-items-center">
                           ...
                           <div class="img-overlay" >
                              <div class="text-right">
                                 <label id="#file">
                                    <div class="hover-icon" title="Edit">
                                       <i class="icon-edit"></i>
                                    </div>
                  ...
                  <div class="row hide-edit-show no-gutters w-100">
                     <div class="col-xl-6 col-lg-6 col-md-12 col-12 pr-md15">
                        <div class="d-flex align-items-center">
                           <div class="f-20 f-md-24 w400 text-ellipsis">Project Name Goes Here</div>
                           <div class=""><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-16"></i></a></div>
                        </div>
                        <p class="f-14 lh140 d-gblue-clr my15 my-md20">Total Videos : 1 <br>
