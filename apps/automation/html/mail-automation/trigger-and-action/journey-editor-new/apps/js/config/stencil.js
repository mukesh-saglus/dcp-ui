...
(function() {
    ...
    App.config.stencil.shapes.standard = [

        {
            ...
            markup: "<g class='rotatable stencil-hover-view' stencil-type='contact'><g class='show-block'><rect class='trigger-stencil'/><image class='icon contact-element-icon'></image><text class='stencil-label'/></g><g class='hide-block'><rect class='trigger-wrap'/><g class='show-on-hover'><rect class='trigger-btn-edit trigger-btn'/><image class='icon trigger-edit' xlink:href='images/editor/edit.svg'></image></g><g class='show-on-hover' event='element:delete'><rect class='trigger-btn-delete trigger-btn'/><image class='icon trigger-delete' xlink:href='images/editor/delete.svg'></image></g><text class='trigger-body-content'>If any contact is added in to a  <tspan class='trigger-content-link' data-toggle='modal' data-target='#ContactModal'>“Specific List”</tspan></text><rect class='trigger-circle'/><rect class='trigger-left-border'/><image class='icon trigger-icon'></image><g class='show-on-hover' event='element:delete'><circle class='trigger-connect-circle' magnet='true'/><image class='icon trigger-connect-icon' xlink:href='images/editor/next.svg' port='yes'></image></g></g></g>",
            ...
            attrs: {
                ...
                ".trigger-btn-edit": {
                    transform: "translate(406, 15)"
                }, 
				".trigger-edit": {
                    transform: "translate(413, 20)",
                    height: 10,
                    width: 6,
                },
				".trigger-btn-delete": {
                    transform: "translate(438, 15)"
                },
				".trigger-delete": {
                    transform: "translate(443, 20)",
                    height: 10,
                    width: 10,
                },
    ...
    App.config.stencil.shapes.fsa = [
            ...
            markup: "<g class='rotatable action-modal' stencil-type='sendemail'><g class='show-block'><rect class='action-stencil'/><image class='icon contact-element-icon'></image><text class='stencil-label'/></g><g class='hide-block' magnet='passive'><rect class='trigger-paper'/><rect class='trigger-header'/><text class='trigger-header-text'/><image class='icon trigger-delete' event='element:delete' xlink:href='images/editor/delete-icon.svg'></image><rect class='trigger-body-text' /><text class='trigger-body-content'  data-toggle='modal' data-target='#DesignSelectionModal'/><circle class='trigger-circle'/><image class='icon trigger-icon'></image><circle class='trigger-connect-circle'/><image class='icon trigger-connect-icon' xlink:href='images/editor/next-icon-white.svg'></image></g></g>",
            // allowOrthogonalResize: false,
