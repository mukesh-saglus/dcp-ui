...
(function(_, joint) {
    ...
    App.MainView = joint.mvc.View.extend({
        ...
        initializePaper: function() {
            ...
            /* delete element of paper*/
            paper.on('element:delete', function(elementView) {
            ...
            paperScroller.render().center();
                ...
                // Paper Container ZoomIn ZoomOut Effect
        ...
        initializeSelection: function() {
            ...
            this.paper.on('blank:pointerdown', function(evt, x, y,linkView) {

                linkView.addTools(toolsView); //SHOW TOOLBAR AND INFO BUTTON ON CLICK ON BLANK AREA
            ...
            // Get ID of contact popup
            this.paper.on('element:pointerdown', function(elementView, evt) {
            //alert('pointerdown on a blank area in the paper.');
            document.getElementById("stencilid").value = elementView.model.id;
            var stencilid = document.getElementById("stencilid").value;
            //alert(stencilid);
            //console.log('A cell with id', elementView.model.id, 'was clicked from the stencil.');
        ...
        initializeToolsAndInspector: function() {
            ...
            this.paper.on({
                        ...
                        options: {
                            ...
                            }, 
                            {
                                ...
                                attributes:{
                                        ...
                                        'xlink:href': 'images/editor/immediately.svg',
                                        'height': 18,
                                        'width': 12,
                                }
                            }],
                            ...
                            offset: 0,
                            action: function(evt) {
                                document.getElementById("timedelayid").value = this.model.id;
                                var timedelayid = document.getElementById("timedelayid").value;
                                // alert(timedelayid);
                                // alert('View id: ' + this.id + '\n' + 'Model id: ' + this.model.id);
                                 $('#WaitTimeModal1').modal('show');
                            },
                        }
                    });
                ...
                'element:pointerup': function(elementView, linkView) {
                    ...
                    // var halodata = new joint.ui.Halo({
                        // cellView: elementView,
                        // handles: App.config.halo.handles
                    // });
                    // halodataEvent =  halodata ;
                    // halodata.removeHandle("remove");
                    // halodata.removeHandle("cut");
                    // halodata.removeHandle("resize");
                    // halodata.removeHandle("link");
                    // halodata.removeHandle("clone");
                    // halodata.removeHandle("rotate");
                    // halodata.removeHandle("fork");
                    // halodata.render();
            ...
            this.graph.on('change', function(cell, opt) {
                console.log(cell.id, ':', cell.get('position'));
            ...
            this.graph.on('click', function(cell, opt) {
             console.log(cell.id, ':', cell.get('position'));
            }, this);
        },
