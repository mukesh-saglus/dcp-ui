    ...
    App.config.stencil.shapes.standard = [
        
        {
            ...
            size: { width: 5, height: 3 },
			       markup: '<g class="rotatable"><g class="show-block"><rect class="element-outer"/><image class="icon contact-element-icon"></image><text class="label-text"/></g><g class="hide-block"><rect class="trigger-header"/><text class="trigger-header-text"/><image class="icon trigger-delete" event="element:delete" xlink:href="images/editor/delete-icon.png"></image><rect class="trigger-body-text"/><text class="trigger-body-content" event="element:dialog" id="contact-modal" /><circle class="trigger-circle"/><image class="icon trigger-icon"></image><circle class="trigger-connect-circle" magnet="true"/><image class="icon trigger-connect-icon" xlink:href="images/editor/next-icon.png" port="Yes"></image></g></g>',
           // allowOrthogonalResize: false,
            ...
            attrs: {
				...
				".element-outer": {
					...
					".contact-element-icon": {transform: "translate(20, 54)",
					 width: 26,
					 height:20,
					 r: 26,
                    },
					".trigger-header": {transform: "translate(26, 30)",
					 width: 228,
					 height:37,
					 r: 26,
					 fill:'#5678ce',
					...
					".trigger-header-text": {transform: "translate(70, 40)",
					 fill:'#fff',
					 text: 'Contact'
                    },
					".trigger-delete": {transform: "translate(230, 40)",
					                 height:12,
									 width:12,
                    },
					".trigger-body-text": {transform: "translate(26, 66)",
					 width: 228,
					 height:60,
					 r: 26,
					 fill:'#fff',
					...
					".trigger-body-content": {transform: "translate(70,80)",
					fill:'#748089',
					...
					".trigger-icon": {transform: "translate(15, 67)",
					 width: 26,
					 height:20,
					 r: 26
                    },
					...
					".trigger-connect-icon": {transform: "translate(250, 69)",
						 height:12,
						 width:7,
						 'pointer-events': 'none',
                    }
            ...
            // ports: {
                // items: [
                   // { group: 'out',
					// attrs: {
						image:{xlinkHref: 'https://cdn.pixabay.com/photo/2018/10/30/16/06/water-lily-3784022__340.jpg'}
						// text: { text: '>' }
					// } 
				   // }
                // ]
