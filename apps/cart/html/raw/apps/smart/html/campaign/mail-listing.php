...
<div class="container-fluid p15 px-md30 py-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		...
		<div class="col-12 col-md-5 f-16 text-center text-md-right">
			...
			<a href="javascript:void(0)" class="base-btn blue-btn mt10 mt-md0" data-toggle="modal" data-target="#createbroadcastModal"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Mail</a>
		</div>
	</div>
	<!-- Header End  -->
	<div class="row">
		<div class="col-xl-2 col-lg-3 col-md-3 col-12">
			...
			<div class="nav flex-column nav-pills ui-vertical-tab f-16 w400">
				...
				<a class="nav-link active" href="mail-listing.php"><i class="icon-mail f-16"></i> Mails <span class="campaign-beta-btn">Beta</span></a>
			</div>
		</div>
				...
				<div class="col-12 col-md-11 bs-h40 table-option-hide pl-md0 col-xl-width2">
					<div class="row">
						<div class="col-12 col-md-4 col-xl-2 mt15 mt-md0">
							<select class="selectpicker" title="All Mails (400)">
								<option>All Mails (400)</option>
								<option>Recently added Mails (10)</option>
								<option>Recently modified Mails (15)</option>
								<option>Mails added in last 07 days (10)</option>
								<option>Mails added in last 30 days (10)</option>
							</select>
						</div>
						<div class="col-12 col-md-4 col-xl-2 mt10 mt-md0">
							<select class="selectpicker" title="Sort by Result">
								<option>Sent Mails</option>
								<option>Open Mails</option>
							</select>
						</div>
						<div class="col-12 col-md-4 col-xl-2 mt10 mt-md0">
							<select class="selectpicker" title="Sort by Type">
								...
								<div class="col-12 col-md-8 col-lg-9 col-xl-10 mt15 mt-md0 d-flex flex-wrap pl-md5">
									<div class="row hide-edit-show no-gutters w-100">
										<div class="col-xl-6 col-lg-5 col-md-12 col-12 pr-md15">
											<div class="d-flex align-items-center">
												<div class="f-18 f-md-20 w500 text-ellipsis">Mail Name Goes Here </div><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-12"></i></a>
											</div>
											<div class="d-gblue-clr mb5">
												<p class="lh150 f-13">Created on: 17 Feb 2020 at 4:08 PM</p>
											</div>
											<span class="f-12 campaign-list-inprocess"><i class="icon-in-process"></i> In Process</span>
										</div>
										<div class="col-xl-6 col-lg-7 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">

											<div class="d-flex justify-content-between flex-wrap w-100">
												<div class="d-flex mr10">
													<div class="campaign-list-icon"><i class="icon-contactts"></i></div>
													<div class="ml10">
														<span class="f-15">Contacts </span>
														<div class="f-24 w700">500 </div>
													</div>
												</div>
												<div class="d-flex mr10">
													<div class="campaign-list-icon"><i class="icon-send-mail"></i></div>
													<div class="ml10">
														<span class="f-15">Sent Mails</span>
														<div class="f-24 w700">30 </div>
													</div>
												</div>
												<div class="d-flex">
													<div class="campaign-list-icon"><i class="icon-opened-mail-one"></i></div>
													<div class="ml10">
														<span class="f-15">Open Mails</span>
														<div class="f-24 w700">50</div>
													</div>
												</div>
											</div>
											<!-- Button -->
											<div class="col-12 text-md-right p0 align-self-end">
												<ul class="list-inline w400 mb0">
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" title="Pause"><i class="icon-paused f-10"></i><span class="hide-text-md">&nbsp;  Pause</span></a>
													</li>
													...
													<li class="list-inline-item mt10 mt-md15"><a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" class="base-btn default-btn list-btn-h25" title="Delete"><i class="icon-delete"></i><span class="hide-text-md">&nbsp;  Delete</span></a>
													</li>
												</ul>
											</div>
										</div>
									...
									<div class="row edit-field-show no-gutters w-100">
										<div class="col-12 col-lg-11 col-xl-8 smart-form campaign-input-field">
											<div class="input-group">
												<input type="text" class="form-control field-h40 fw100 mb15 mb-md0" value="Mail Name Goes Here">
												<div class="input-group-append">
								...
								<div class="col-12 col-md-8 col-lg-9 col-xl-10 mt15 mt-md0 d-flex flex-wrap pl-md5">
									<div class="row hide-edit-show no-gutters w-100">
										<div class="col-xl-6 col-lg-5 col-md-12 col-12 pr-md15">
											...
											<span class="f-12 campaign-list-active"><i class="icon-dot-tick"></i> Completed</span>
										</div>
										<div class="col-xl-6 col-lg-7 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
											...
											<div class="col-12 text-md-right p0 align-self-end">
												<ul class="list-inline w400 mb0">
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" title="Re-use"><i class="icon-clicked"></i><span class="hide-text-md">&nbsp;  Re-use</span></a>
													</li>
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" title="Analytics"><i class="icon-report"></i><span class="hide-text-md">&nbsp;  Analytics</span></a>
													</li>
													<li class="list-inline-item mt10 mt-md15"><a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" class="base-btn default-btn list-btn-h25" title="Delete"><i class="icon-delete"></i><span class="hide-text-md">&nbsp;  Delete</span></a>
								...
								<div class="col-12 col-md-8 col-lg-9 col-xl-10 mt15 mt-md0 d-flex flex-wrap pl-md5">
									<div class="row hide-edit-show no-gutters w-100">
										<div class="col-xl-6 col-lg-5 col-md-12 col-12 pr-md15">
											...
											<span class="f-12 campaign-list-inprocess"><i class="icon-paused f-8"></i> Paused</span>
										</div>
										<div class="col-xl-6 col-lg-7 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
											...
											<div class="col-12 text-md-right p0 align-self-end">
												<ul class="list-inline w400 mb0">
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" title="Resume"><i class="icon-next-one f-12"></i><span class="hide-text-md">&nbsp;  Resume</span></a>
													</li>
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" title="Analytics"><i class="icon-report"></i><span class="hide-text-md">&nbsp;  Analytics</span></a>
													</li>
													<li class="list-inline-item mt10 mt-md15"><a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" class="base-btn default-btn list-btn-h25" title="Delete"><i class="icon-delete"></i><span class="hide-text-md">&nbsp;  Delete</span></a>
								...
								<div class="col-12 col-md-8 col-lg-9 col-xl-10 mt15 mt-md0 d-flex flex-wrap pl-md5">
									<div class="row hide-edit-show no-gutters w-100">
										<div class="col-xl-6 col-lg-5 col-md-12 col-12 pr-md15">
											...
											<span class="f-12 campaign-list-private"><i class="icon-draft"></i>&nbsp; Draft</span>
										</div>
										<div class="col-xl-6 col-lg-7 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
											...
											<div class="col-12 text-md-right p0 align-self-end">
												<ul class="list-inline w400 mb0">
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" title="Edit"><i class="icon-edit"></i><span class="hide-text-md">&nbsp;  Edit</span></a>
													</li>
													<li class="list-inline-item mt10 mt-md15"><a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" class="base-btn default-btn list-btn-h25" title="Delete"><i class="icon-delete"></i><span class="hide-text-md">&nbsp;  Delete</span></a>
													</li>
												</ul>
								...
								<div class="col-12 col-md-8 col-lg-9 col-xl-10 mt15 mt-md0 d-flex flex-wrap pl-md5">
									<div class="row hide-edit-show no-gutters w-100">
										<div class="col-xl-6 col-lg-5 col-md-12 col-12 pr-md15">
											...
											<span class="f-12 campaign-list-scheduled"><i class="icon-scheduled"></i>&nbsp; Scheduled 6 Feb 2020</span>
										</div>
										<div class="col-xl-6 col-lg-7 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
											...
											<div class="col-12 text-md-right p0 align-self-end">
												<ul class="list-inline w400 mb0">
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" title="Send Now"><i class="icon-send-mail"></i><span class="hide-text-md">&nbsp;  Send Now</span></a>
													</li>
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" title="Re-use"><i class="icon-clicked"></i><span class="hide-text-md">&nbsp;  Re-use</span></a>
													</li>
													<li class="list-inline-item mt10 mt-md15"><a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal" class="base-btn default-btn list-btn-h25" title="Delete"><i class="icon-delete"></i><span class="hide-text-md">&nbsp;  Delete</span></a>
					...
					<div class="border radius5 relative">
						...
						<div class="filter-scrollbar mCustomScrollbar" data-mcs-theme="inset-3">
							...
							<div class="clearfix filter-divide-bg">
								...
								<div class="form-group mb0">
									<select class="selectpicker f-14" title="In process">
