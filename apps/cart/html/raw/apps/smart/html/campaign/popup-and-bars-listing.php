...
<div class="container-fluid p15 px-md30 py-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		...
		<div class="col-12 col-md-5 f-16 text-center text-md-right">
			...
			<a href="javascript:void(0)" class="base-btn blue-btn mt10 mt-md0" data-toggle="modal" data-target="#AddNewCampaignsModal"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp;  Popup & Bar</a>
		</div>
	</div>
	<!-- Header End  -->
	<div class="row">
		<div class="col-xl-2 col-lg-3 col-md-3 col-12">
			...
			<div class="nav flex-column nav-pills ui-vertical-tab f-16 w400">
				...
				<a class="nav-link active" href="popup-and-bars-listing.php"><i class="icon-editor-popup f-16"></i> Popups & Bars</a>
				...
				<div class="col-12 col-md-11 bs-h40 table-option-hide pl-md0 col-xl-width2">
					<div class="row">
						<div class="col-12 col-md-4 col-xl-2 mt15 mt-md0">
							<select class="selectpicker" title="All Popups & Bars (400)">
								<option>All Popups & Bars (400)</option>
								<option>Recently added Popups & Bars (10)</option>
								<option>Recently modified Popups & Bars (15)</option>
								<option>Popups & Bars added in last 07 days (10)</option>
								<option>Popups & Bars added in last 30 days (10)</option>
							</select>
						</div>
								...
								<div class="col-12 col-md-8 col-lg-9 col-xl-10 mt15 mt-md0 d-flex flex-wrap pl-md5">
									<div class="row hide-edit-show no-gutters w-100">
										<div class="col-xl-6 col-lg-5 col-md-12 col-12 pr-md15">
											<div class="d-flex align-items-center">
												<div class="f-18 f-md-20 w500 text-ellipsis">Popup & Bar Name Goes Here </div><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-12"></i></a>
											</div>
										...
										<div class="col-xl-6 col-lg-7 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
											...
											<div class="d-flex justify-content-between flex-wrap w-100">
												<div class="d-flex mr10">
													<div class="campaign-list-icon"><i class="icon-all-accounts"></i></div>
													<div class="ml10">
														<span class="f-15">Visitors</span>
												...
												<div class="d-flex">
													...
													<div class="ml10">
														<span class="f-15">Conversion Rate</span>
											...
											<div class="col-12 text-md-right p0 align-self-end">
												<ul class="list-inline w400 mb0">
													...
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" title="View"><i class="icon-show"></i><span class="hide-text-md">&nbsp;  View</span></a>
													</li>
													<li class="list-inline-item mt10 mt-md15 dropdown simple-dropdown caret-icon-none">
														...
														<ul class="dropdown-menu dropdown-menu-right mCustomScrollbar f-14" data-mcs-theme="inset-3" aria-labelledby="dropdownMenu1">
															...
															<li> <a class="dropdown-item" href="javascript:void(0)">Get Embed Code</a></li>
														</ul>
													</li>
												</ul>
											</div>
									...
									<div class="row edit-field-show no-gutters w-100">
										<div class="col-12 col-lg-11 col-xl-8 smart-form campaign-input-field">
											<div class="input-group">
												<input type="text" class="form-control field-h40 fw100 mb15 mb-md0" value="Popup & Bar Name Goes Here">
												<div class="input-group-append">
					...
					<div class="border radius5 relative">
						...
						<div class="filter-scrollbar mCustomScrollbar" data-mcs-theme="inset-3">
							...
							<div class="clearfix filter-divide-bg">
								...
								<div class="form-group mb0">
									<select class="selectpicker f-14" title="Active">
										<option>Active</option>
										<option>In Active</option>
										<option>Draft</option>
									</select>
							...
							<div class="clearfix filter-divide-bg">
								...
								<div class="form-group mb0">
									<select class="selectpicker f-14" title="Web Notification">
