...
<ul class="nav tabs-style3 f-14 f-md-16 w-100 relative" role="tablist">
	...
	<a class="nav-link active lh110" href="web-analytics-overview.php">
		...
		<div class="col-12 col-md-3 col-lg-3 mb15 mb-md0">
			<div class="media">
				...
				<div class="media-body align-self-center ml15 ml-md30">
					...
					<p class="lato-font vd-gblue-clr w700 f-30 f-lg-36 mt8 d-inline-block" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="All Audience - 1527822">1.5 M</p>
				</div>
			</div>
		</div>
		<div class="col-12 col-md-3 col-lg-3 mb15 mb-md0">
...
<!------- Audience Traffic Graph Section Start----------->
	...
	<div class="row">
		<!------ Title Header-------------->
		<div class="col-12 col-md-8 col-lg-9 mb15 mb-md0">
			<h4>Audience Traffic Graph</h4>
			<p class="f-14 lh140 d-gblue-clr w400">Check audience traffic stats for the selected period</p>
		</div>
		...
		<div class="row mt-md30">
			<div class="col-md-4 col-lg-4 col-xl-3 bs-h40 mb10 mb-md0">
				<select class="selectpicker f-14">
					...
					<option>Recently added (500)</option>
					<option>Unique id added in last 07 days (330)</option>
					<option>Unique id added in last 30 days (150)</option>
				</select>
			</div>
