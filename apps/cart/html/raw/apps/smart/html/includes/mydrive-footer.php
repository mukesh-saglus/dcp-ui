...
<!----------- Footer Section-------------->
<div class="footer-sticky-height1"></div>
<footer class="footer-design" >
  <div class="container-fluid px-md30">
    <div class="row">
      <div class="col-12 d-flex justify-content-center justify-content-md-end flex-wrap f-14">
        <div>Copyright 2019 @dotcompal.com</div>
