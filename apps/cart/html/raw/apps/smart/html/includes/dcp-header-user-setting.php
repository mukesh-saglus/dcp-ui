...
<div class="smart-nav-area col-12">
	<div class="row no-gutters h-100">
			<div class="col-10 col-sm-9 col-md-3 col-lg-3 col-xl-2 d-flex align-items-center">
				<a href="#" class="f-16 f-md-20 w400 white-clr t-decoration-none">Admin Settings</a>
			</div>
					...
					<div class="collapse navbar-collapse xs-device-menu" id="smartappmenu">
						<ul class="navbar-nav">
							<li class="nav-item dropdown">
								<a class="nav-link" href="#" title="Businesses">
								Businesses
								</a>
							</li>
							<li class="nav-item dropdown">
								<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Subscription">
								Subscription
								</a>
								<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
									<li><a class="dropdown-item" href="#" title="Current Subscription">Current Subscription</a></li>
									<li><a class="dropdown-item" href="#" title="Payment History">Payment History</a></li>
									<!--<li><a href="#" class="dropdown-item" title="Cancel Account">Cancel Account</a></li>
										<li><a href="#" class="dropdown-item" title="Buy Ad-ons">Buy Ad-ons</a></li>-->
								</ul>
							</li>
							<li class="nav-item dropdown">
								<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Team Management">
								Team Management
								</a>
								<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
									<li><a class="dropdown-item" href="#" title="Team Members">Team Members</a></li>
									<li><a class="dropdown-item" href="#" title="Team Profiles">Team Profiles</a></li>
								</ul>
							</li>
							<li class="nav-item dropdown">
								<a class="nav-link" href="#" title="General">
								General 
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="#" title="User Profile" role="button">
								User Profile
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="#" title="Security" role="button">
								Security
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="#" title="Notification" role="button">
								Notification
								</a>
							</li>
						</ul>
