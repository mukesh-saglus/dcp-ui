...
<div class="s-header d-flex justify-content-between">
	...
	<div class="align-self-center d-flex">
		...
		<ul class="top-right-icon f-16 f-md-20">
			<!------------ Setting Dropdown----------------->
			<li class="list-link dropdown caret-icon-none"><a class="list-inline-link" href="<?php echo $basedir; ?>apps/training/html/training.php"><i class="icon-help-n-training f-20 f-md-24"></i></a>
			</li>
