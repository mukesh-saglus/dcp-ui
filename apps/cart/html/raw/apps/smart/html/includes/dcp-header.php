                     ...
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                           ...
                           Campaigns 
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <li><a class="dropdown-item" href="#" title="Journey">Journey</a></li>
                              <li><a class="dropdown-item" href="#" title="Page">Page</a></li>
                              <li><a class="dropdown-item" href="#" title="Video">Video</a></li>
                              <li><a href="#" class="dropdown-item" title="Popup & Bar">Popup & Bar</a></li>
                              <li><a href="#" class="dropdown-item" title="Broadcast">Broadcast</a></li>
						...
						<li class="nav-item dropdown">
                           ...
                           Analytics 
							...
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								...
								<li><a class="dropdown-item" href="#" title="Page">Page</a></li>
								<li><a class="dropdown-item" href="#" title="Video">Video</a></li>
								<li><a class="dropdown-item" href="#" title="Popup & Bar">Popup & Bar</a></li>

							</ul>
                        </li> 
						<li class="nav-item dropdown">
                           <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="More Apps">
                           More Apps 
                           </a>
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">	
								<li><a class="dropdown-item" href="#" title="MyDrive">MyDrive</a></li>
								<li><a class="dropdown-item" href="#" title="Integration">Integration</a></li>
							</ul>
                        </li> 
