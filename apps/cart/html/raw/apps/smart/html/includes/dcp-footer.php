...
<!-- Cart Common modal Include File -->
<?php include '../../../cart/includes/common-modals-cart.php'; ?>
<!-- Cart Common modal Include File end -->
	...
	<div class="container-fluid px-md30">
		<div class="row">
			<div class="col-12 d-flex justify-content-between flex-wrap f-14">
				<div><span class="copyright">&copy;</span> 2020 onwards. All Rights Reserved. Dotcompal is brought to you by SAGLUS Info Pvt. Ltd. <a href="#" class="privacy-links">Privacy Policy</a> and <a href="#" class="footer-links">Terms of Service</a></div>
...
<!--- Funnel Preview Popup js --->
<script type='text/javascript' src="<?php echo $basedir; ?>apps/funnel/js/funnel.js"></script>
<!-- Fastselect Master Tags Css and JS file -->
<link rel="stylesheet" href="<?php echo $basedir; ?>vendors/fastselect-master/fastselect.min.css">
<script src="<?php echo $basedir; ?>vendors/fastselect-master/fastselect.standalone.js"></script>
<script>
