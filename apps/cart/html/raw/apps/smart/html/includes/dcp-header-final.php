							...
							<div class="accordion" id="accordion">
							   <div class="card">
								  <div class="card-header" data-toggle="collapse" href="#menu1" aria-expanded="true">
									 <a class="card-title"><span class="icon-box"><i class="icon-grows"></i></span>Campaign</a>
								  </div>
								  ...
								  <div id="menu2" class="collapse" data-parent="#accordion">
									 <div class="card-body">
										<ul class="dcp-solution-nav">
										   ...
										   <li class="nav-item">
											  <a class="nav-link" href="#">
												 <i class="icon-crosssells icon-style"></i>
												 <div class="title">CrossSell</div>
											  </a>
										   </li> 
										   <li class="nav-item">
											  <a class="nav-link" href="#">
												 <i class="icon-levels icon-style"></i>
												 <div class="title">lavel</div>
											  </a>
										   </li> 
										   <li class="nav-item">
											  <a class="nav-link" href="#">
												 <i class="icon-tickett icon-style"></i>
							   ...
							   <div class="card">
								  <div class="card-header collapsed" data-toggle="collapse" href="#menu3" aria-expanded="true">
									 <a class="card-title"><span class="icon-box"><i class="icon-more"></i></span>More Apps</a>
								  </div>
               ...
               <nav class="navbar navbar-expand-xl navbar-light p0 smart-nav-header f-14 f-lg-16 w-100">
                  ...
                  <div class="collapse navbar-collapse xs-device-menu" id="smartappmenu">
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                           <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Campaign">
                           Campaign 
                           </a>
                              <ul class="dropdown-menu mCustomScrollbar header-dropdown-scrollbar" aria-labelledby="navbarDropdown" data-mcs-theme="inset-3">
                              <li><a class="dropdown-item" href="#" title="Journey / Funnels">Journey / Funnels</a></li>
                              <li><a class="dropdown-item" href="#" title="Landing Pages">Landing Pages</a></li>
                              ...
                              <li><a href="#" class="dropdown-item" title="SMS">SMS</a></li>
                              <li><a href="#" class="dropdown-item" title="Webinars">Webinars</a></li>
							  <li class="dropdown-sepration mt5"><a href="#" class="dropdown-item" title="All Campaigns">All Campaigns</a></li></ul>
                        </li>
						<li class="nav-item dropdown">
                           ...
                           A/B Test
                             ...
                             <ul class="dropdown-menu mCustomScrollbar header-dropdown-scrollbar" aria-labelledby="navbarDropdown" data-mcs-theme="inset-3">
                              ...
                              <li><a href="#" class="dropdown-item" title="Pops & Bars">Pops & Bars</a></li>
							  <li><a href="#" class="dropdown-item" title="Mail">Mail</a></li>							   
							  </ul>
                        </li>
						<li class="nav-item dropdown">
                           ...
                           Analytics 
							...
							<ul class="dropdown-menu mCustomScrollbar header-dropdown-scrollbar" aria-labelledby="navbarDropdown" data-mcs-theme="inset-3">
								...
								<li><a class="dropdown-item" href="#" title="Contacts">Contacts</a></li>
								<li><a class="dropdown-item" href="#" title="Sales">Sales</a></li>
								<li><a class="dropdown-item" href="#" title="Orders">Orders</a></li>
								<li><a class="dropdown-item" href="#" title="Tickets">Tickets</a></li>
								...
								<li><a class="dropdown-item" href="#" title="Webinar">Webinar</a></li>
						...
						<li class="nav-item dropdown">
                          ...
                          More
							...
							<ul class="dropdown-menu mCustomScrollbar header-dropdown-scrollbar" aria-labelledby="navbarDropdown" data-mcs-theme="inset-3">	
								...
								<li><a class="dropdown-item" href="#" title="Products">Products</a></li>
								<li><a class="dropdown-item" href="#" title="Coupons">Coupons</a></li>
								<li><a class="dropdown-item" href="#" title="Orders">Orders</a></li>
								...
								<li><a class="dropdown-item" href="#" title="CrossSell">CrossSell</a></li>
								<li><a class="dropdown-item" href="#" title="lavel">lavel</a></li>
								<li><a class="dropdown-item" href="#" title="Tickets">Tickets</a></li>
							</ul>
                        </li> 
