	...
	<div class="row">
	    <div class="col-12">
         <ul class="stepwizard-style2 f-20 f-md-24 w400 lato-font">
            ...
            <li> <a href="#">Manuall Wordpress Installation</a> </li>
         </ul>
         <p class="f-14 gblue-clr w400">Install DotcomPal on your WordPress website</p>
      </div>
...
<div class="container-fluid p15 p-md30 pt0 smart-script-toggle">
	<div class="row">
    	<div class="col-12 col-md-12 col-lg-8 d-block mx-auto mt15 mb15 mt-md70 mb-md70">
            ...
            <h3 class="w500 text-center firasans-font mt15 mt-md50 f-24">
            Step 1  
            </h3>
            ...
            <img src="<?php echo $basedir; ?>images/installation/wordpress-part1.gif" class="img-fluid d-block mx-auto" />
            </div>
            
            <h3 class="w500 text-center firasans-font mt15 mt-md60">
            Step 2  
            </h3>
            <p class="f-16 f-md-18 w400 text-center mt15 lh150">
            Login to your Wordpress Admin Account, locate the option "Appearance" > "Editor" on the left nav.
            </p>
            
            <div class="mt15 mt-md36">
            <img src="<?php echo $basedir; ?>images/installation/wordpress-part2.gif" class="img-fluid d-block mx-auto" />
            </div>
            ...
            <p class="f-16 f-md-18 w400 text-center mt15 lh150">
			Once you open the Editor, click on "Theme Header". The name maybe different for different themes,idea is for you to find the common Header file.
            Copy-paste this piece of code and Hit Update File!
            </p>
            
            <div class="mt15 mt-md40">
            <img src="<?php echo $basedir; ?>images/installation/wordpress-part3.gif" class="img-fluid d-block mx-auto" />
            </div>
            ...
            <div class="mt15 mt-md40">
            <img src="<?php echo $basedir; ?>images/installation/wordpress-part4.gif" class="img-fluid d-block mx-auto" />
            </div>
