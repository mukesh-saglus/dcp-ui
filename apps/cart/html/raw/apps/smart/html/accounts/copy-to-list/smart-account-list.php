...
<div class="container-fluid p15 p-md30">
	<div class="row align-items-center">
		...
		<span class="f-md-24 f-20 lato-font">Contacts </span> &nbsp;
		...
		<a href="../import-accounts/import-from-pc.php" class="base-btn default-btn mt10 mt-md0">Import</a>&nbsp;
		<a href="#" class="base-btn default-btn mt10 mt-md0">Export</a>&nbsp;
		<a href="javascript:void(0)" data-toggle="modal" data-target="#" class="base-btn blue-btn mt10 mt-md0"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Account</a>
		</div>
	</div>
            ...
            <div id="thori-scroll" class="table-responsive smart-table-style">
              <table class="table table-bordered">
                ...
                <div class="table-option-manage animated fadeIn">
					...
					<li class="list-inline-item"><a href="#" class="base-btn default-btn btn-h30 f-14" data-toggle="modal" data-target="#CopyAccountsToListModal" title="Copy to list"><i class="icon-copy"></i> Copy to list</a></li>
