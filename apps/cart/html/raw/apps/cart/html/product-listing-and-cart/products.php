...
<div class="container-fluid p15 p-md30  pt-md10">
	<div class="row align-items-center">
		<div class="col-12 mb10">
			<div class="d-flex align-items-center flex-wrap">
				<ul class="stepwizard-style4 f-14 w400">
					...
					<li><a href="#" class="p-blue-clr"><span>Items</span></a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="col-12 col-md-5 mt10 mt-md0 text-center text-md-right">
			...
			<a href="#" class="base-btn blue-btn"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Item </a>
		</div>
	</div>
		...
		<div class="col-12">
			<div class="row">
				...
				<div class="col-md-9 offset-md-0 col-lg-9 col-xl-9">
					<div class="row">
						<div class="col-md-3 col-lg-2 col-xl-3 offset-xl-1 mb10 mb-md0 smart-form bs-h40">
