...
<div class="container-fluid p15 p-md30  pt-md10">
	<div class="row align-items-center">
		<div class="col-12 mb10">
			<div class="d-flex align-items-center flex-wrap">
				<ul class="stepwizard-style4 f-14 w400">
					...
					<li><a href="#" class="p-blue-clr"><span>Order Management</span></a>
                    </li>
				</ul>
			</div>
		</div>
		<div class="col-12 col-md-7">	<span class="f-md-24 f-20 lato-font">Order Management </span> &nbsp;	<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
		...
		<div class="col-12 col-md-5 mt10 mt-md0 text-center text-md-right">
			<!-- <a href="javascript:void(0)" class="base-btn default-btn mt10 mt-md0 mr5">Import History</a> -->	<a href="#" class="base-btn blue-btn"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Order </a>
		</div>
	</div>
		...
		<div class="col-12">
			<div class="row">
				<div class="col-md-4 col-lg-4 col-xl-3 bs-h40 mb10 mb-md0 smart-form">
					<select class="selectpicker f-14" title="All Orders (400)">
						<option>All Orders (400)</option>
						<option>Recently added Orders (10)</option>
						<option>Recently modified Orders (15)</option>
						<option>Orders added in last 07 days (10)</option>
						<option>Orders added in last 30 days (10)</option>
					</select>
				</div>
				<div class="col-md-8 offset-md-0 col-lg-8 col-xl-9">
					<div class="row">
						<div class="col-md-5 col-lg-4 col-xl-4 offset-xl-2 mb10 mb-md0 smart-form">
						...
						<tr>
							...
							<td>
								<ul class="table-action">
									...
									<li class="action-menu"><a href="#" class="action-item" title="Status"><i class="icon-status"></i></a>
									</li>
