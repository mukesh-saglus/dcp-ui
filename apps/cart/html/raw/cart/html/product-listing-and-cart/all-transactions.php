		...
		<div class="col-12 mb10">
			<div class="d-flex align-items-center flex-wrap">
				<ul class="stepwizard-style4 f-14 w400">
					...
					<li><a href="#" class="p-blue-clr"><span>Transactions</span></a>
					</li>
				</ul>
			</div>
		</div>
		<div class="col-12 col-md-7">	<span class="f-md-24 f-20 lato-font">All Transactions </span> &nbsp;	<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
		...
		<div class="col-12">
			<div class="row">
				<div class="col-md-3 col-lg-3 col-xl-3 bs-h40 mb10 mb-md0 smart-form">
					<select class="selectpicker f-14" title="All Transactions (400)">
						<option>All Transactions (400)</option>
						<option>Recently added Transactions (10)</option>
						<option>Recently modified Transactions (15)</option>
						<option>Transactions added in last 07 days (10)</option>
						<option>Transactions added in last 30 days (10)</option>
					</select>
				</div>
				<div class="col-md-9 offset-md-0 col-lg-9 col-xl-9">
					<div class="row">
						<div class="col-md-3 col-lg-3 col-xl-3 offset-xl-0 mb10 mb-md0 smart-form bs-h40">
						...
						<div class="col-md-3 col-lg-3 col-xl-3 mb10 mb-md0">
				...
				<table class="table table-bordered">
					...
					<div class="table-option-manage animated fadeIn">
						<ul class="list-inline f-14 w400 mb0">
							<li class="list-inline-item"><a href="#" class="base-btn default-btn btn-h30 f-14" title="Download"><i class="icon-import"></i> Download</a>
							</li>
						...
						<tr>
							...
							<td>
								<ul class="table-action">
									<li class="action-menu"><a href="#" class="action-item" title="Download"><i class="icon-import"></i></a>
									</li>
									<li class="action-menu"><a href="#" class="action-item" title="Mail"><i class="icon-mail"></i></a>
									</li>
								</ul>
							</td>
						</tr>
