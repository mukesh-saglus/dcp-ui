...
<div class="container-fluid p15 p-md30  pt-md10">
	<div class="row align-items-center">
		...
		<div class="col-12 col-md-5 mt10 mt-md0 text-center text-md-right">
			<!-- <a href="javascript:void(0)" class="base-btn default-btn mt10 mt-md0 mr5">Import History</a> -->	<a href="#" class="base-btn blue-btn" data-toggle="modal" data-target="#createLevelModal"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Order </a>
		</div>
	</div>
