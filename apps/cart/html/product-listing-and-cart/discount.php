...
<div class="container-fluid p15 p-md30  pt-md10">
	<div class="row align-items-center">
		<div class="col-12 mb10">
			<div class="d-flex align-items-center flex-wrap">
				<ul class="stepwizard-style4 f-14 w400">
					...
					<li><a href="#" class="p-blue-clr"><span>Discounts</span></a>
					</li>
				</ul>
			</div>
		</div>
		<div class="col-12 col-md-7">	<span class="f-md-24 f-20 lato-font">Discounts/Coupons </span> &nbsp;	<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
		...
		<div class="col-12 col-md-5 mt10 mt-md0 text-center text-md-right">
			...
			<a href="#" class="base-btn blue-btn"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Discount </a>
		</div>
	</div>
	<div class="row mt-md30 mt15">
		...
		<div class="col-12">
			<div class="row">
				<div class="col-md-4 col-lg-3 col-xl-3 bs-h40 mb10 mb-md0 smart-form">
					<select class="selectpicker f-14" title="All Discounts (400)">
						<option>All Discounts (400)</option>
						<option>Recently added Discounts (10)</option>
						<option>Recently modified Discounts (15)</option>
						<option>Discounts added in last 07 days (10)</option>
						<option>Discounts added in last 30 days (10)</option>
					</select>
				</div>
				<div class="col-md-8 offset-md-0 col-lg-9 col-xl-9">
					<div class="row">
						<div class="col-md-4 col-lg-3 col-xl-3 offset-xl-3 offset-lg-1 mb10 mb-md0 smart-form bs-h40">
							<select class="selectpicker f-14">
								<option>Active</option>
								<option>Inactive</option>
							</select>
						</div>
						<div class="col-md-4 col-lg-5 col-xl-4 mb10 mb-md0">
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th>Name/Title &nbsp;<i class="fa fa-sort"></i></th>
							<th>Expires</th>
							<th>Maximum Limit</th>
							<th>No. of Usage</th>
							<th>Actions</th>
					...
					<tbody>
						<tr>
							...
							<td><a href="#" class="p-blue-clr t-decoration-none">Coupon Name/Title 1</a></td>
							...
							<td>
								<ul class="table-action">
									...
									<li class="action-menu"><a href="#" class="action-item" title="Delete"><i class="icon-delete"></i></a>
									</li>
						...
						<tr>
							...
							<td><a href="#" class="p-blue-clr t-decoration-none">Coupon Name/Title 2</a></td>
							<td>02 May 2020 at 02:15 PM</td>
							<td>5000</td>
							<td>1000</td>
							<td>
						...
						<tr>
							...
							<td><a href="#" class="p-blue-clr t-decoration-none">Coupon Name/Title 3</a></td>
							<td>02 May 2020 at 02:15 PM</td>
							<td>5000</td>
							<td>1000</td>
							<td>
						...
						<tr>
							...
							<td><a href="#" class="p-blue-clr t-decoration-none">Coupon Name/Title 4</a></td>
							<td>02 May 2020 at 02:15 PM</td>
							<td>5000</td>
							<td>1000</td>
							<td>
