    ...
    <div class="row">
        <div class="col-md-4 col-lg-3 col-xl-2 pr-md0">
            <div class="nav flex-column nav-pills ui-vertical-tab f-16 w400 side-tab-fixed left-tab-fixed">
                ...
                <a class="nav-link" href="files-and-folders.php"><i class="icon-folder"></i>Files & Folders <span class="page-count-btn">5</span></a>
                <a class="nav-link active" href="videos-and-playlist.php"><i class="icon-total-viewed-videos"></i>Videos & Playlist</a>
            </div>
        </div>
        <div class="col-md-8 col-lg-9 col-xl-10 pl-md30">
            ...
            <div class="col-12 p0 sticky-design-selection mb15 mb-md30">
                <div class="row align-items-center bs-h40">
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3 mt15 mt-md0">
                        <p class="f-16 f-md-18 w500 text-truncate">Videos & Playlist</p>
                    </div>
            ...
            <div class="row break-word">
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb15 mb-md30">
                    <div class="gradient-border1 relative mytooltip-hover">
                        <a data-toggle="modal" data-target="#videoModal" class="library-block d-flex align-items-center vl-gblue-bg">
                            <img src="../../images/video-image4.png" class="d-block mx-auto img-fluid" />
                            <!----- Video icon css--->
                            <span class="lib-video-icon white-clr">
                                <i class="icon-total-viewed-videos f-35"></i>
                            </span>
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb15 mb-md30">
                    <div class="gradient-border1 relative mytooltip-hover">
                        <a data-toggle="modal" data-target="#videoModal" class="library-block d-flex align-items-center vl-gblue-bg">
                            <img src="../../images/video-image5.png" class="d-block mx-auto img-fluid" />
                            <!----- Video icon css--->
                            <span class="lib-video-icon white-clr">
                                <i class="icon-total-viewed-videos f-35"></i>
                            </span>
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb15 mb-md30">
                    <div class="gradient-border1 relative mytooltip-hover">
                        <a data-toggle="modal" data-target="#videoModal" class="library-block d-flex align-items-center vl-gblue-bg">
                            <img src="../../images/video-image6.png" class="d-block mx-auto img-fluid" />
                            <!----- Video icon css--->
                            <span class="lib-video-icon white-clr">
                                <i class="icon-total-viewed-videos f-35"></i>
                            </span>
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb15 mb-md30">
                    <div class="gradient-border1 relative mytooltip-hover">
                        <a data-toggle="modal" data-target="#videoModal" class="library-block d-flex align-items-center vl-gblue-bg">
                            <img src="../../images/video-image7.png" class="d-block mx-auto img-fluid" />
                            <!----- Video icon css--->
                            <span class="lib-video-icon white-clr">
                                <i class="icon-total-viewed-videos f-35"></i>
                            </span>
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb15 mb-md30">
                    <div class="gradient-border1 relative mytooltip-hover">
                        <a data-toggle="modal" data-target="#videoModal" class="library-block d-flex align-items-center vl-gblue-bg">
                            <img src="../../images/video-image8.png" class="d-block mx-auto img-fluid" />
                            <!----- Video icon css--->
                            <span class="lib-video-icon white-clr">
                                <i class="icon-total-viewed-videos f-35"></i>
                            </span>
