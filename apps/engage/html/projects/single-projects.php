...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		...
		<p class="f-14 gblue-clr w400">Here you can manage your project</p>
		</div>
		<div class="col-12 col-md-6 col-lg-5 text-center text-md-right mt10 mt-md0 f-16 w400">
			...
			<a href="javascript:" class="base-btn blue-btn" data-toggle="modal" data-target="#AddNewCampaignsModal" ><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Campaign</a>
		</div>
