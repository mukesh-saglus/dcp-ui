...
<div class="container-fluid p15 p-md30">
   ...
   <div class="row mb15 mb-md30">
      <div class="col-12">
         ...
         <p class="f-14 gblue-clr">Choose from our awesomely designed converting templates or start creating your own</p>
      </div>
   </div>
   <!------- Header End ----------->
   ...
   <div class="row">
      <div class="col-md-4 col-lg-3 col-xl-2">
         <div class="nav flex-column nav-pills ui-vertical-tab f-16 w400 side-tab-fixed">
            ...
            <a class="nav-link active" href="create-your-own-design.php"><i class="icon-create-your-own"></i>Create From Scratch</a>
         </div>
      </div>
      <div class="col-md-8 col-lg-9 col-xl-10">
                  ...
                  <div class="d-flex justify-content-start flex-wrap row bs-h40">
                     ...
                     <div class="col-12 col-md-3 col-lg-3 mt15 mt-md0">
                        <select class="selectpicker f-16" title="All Position">
                           ...
                           <option>Sticky Bars</option>
                           <option>Notification Boxes</option>
                        </select>
                     </div>
                     <div class="col-12 col-md-3 col-lg-3 mt15 mt-md0">
         ...
         <div class="row">
            <div class="col-12 col-md-4 col-lg-3 mb15 mb-md30">
               <a href="JavaScript:Void(0);" data-toggle="modal" data-target="#ABTestPageModal" class="design-gallery-grid p15">
                  <img src="../../../../images/web-footer.png" class="img-fluid d-block mx-auto">
                  <!---- Checked icon Div ---->
               ...
               <div class="d-flex justify-content-between mt10">
                  <div class="f-14 w400 align-self-center">Sticky Bars</div>
            ...
            <div class="col-12 col-md-4 col-lg-3 mb15 mb-md30">
               <a href="JavaScript:Void(0);" data-toggle="modal" data-target="#ABTestPageModal" class="design-gallery-grid p15">
                  <img src="../../../../images/lightbox.png" class="img-fluid d-block mx-auto">
                  <!---- Checked icon Div ---->
                  <div class="absolute lib-popup-icon s-green-bg rounded-circle align-self-center d-none">
                     <i class="icon-tick white-clr f-11"></i>
                  </div>
               ...
               <div class="d-flex justify-content-between mt15">
                  <div class="f-14 w400 align-self-center">Lightbox</div>
                  <div class="ml15"><a href="#" class="tem-preview-btn t-decoration-none"  data-toggle="modal" data-target="#lightboxTempModal" data-backdrop="static" data-keyboard="false">
                     <i class="icon-show"></i>
                     </a>
                  </div>
            ...
            <div class="col-12 col-md-4 col-lg-3 mb15 mb-md30">
               <a href="JavaScript:Void(0);" data-toggle="modal" data-target="#ABTestPageModal" class="design-gallery-grid p15">
                  <img src="../../../../images/box.png" class="img-fluid d-block mx-auto">
                  <!---- Checked icon Div ---->
                  <div class="absolute lib-popup-icon s-green-bg rounded-circle align-self-center d-none">
                     <i class="icon-tick white-clr f-11"></i>
                  </div>
               ...
               <div class="d-flex justify-content-between mt10">
                  <div class="f-14 w400 align-self-center">Notification Box</div>
                  <div class="ml15"><a href="#" class="tem-preview-btn t-decoration-none"  data-toggle="modal" data-target="#lightboxTempModal" data-backdrop="static" data-keyboard="false">
                     <i class="icon-show"></i>
                     </a>
                  </div>
            ...
            <div class="col-12 col-md-4 col-lg-3 mb15 mb-md30">
               <a href="JavaScript:Void(0);" data-toggle="modal" data-target="#ABTestPageModal" class="design-gallery-grid p15">
                  <img src="../../../../images/full-screen.png" class="img-fluid d-block mx-auto">
                  <!---- Checked icon Div ---->
                  <div class="absolute lib-popup-icon s-green-bg rounded-circle align-self-center d-none">
                     <i class="icon-tick white-clr f-11"></i>
                  </div>
               ...
               <div class="d-flex justify-content-between mt10">
                  <div class="f-14 w400 align-self-center">Full Screen</div>
                  <div class="ml15"><a href="#" class="tem-preview-btn t-decoration-none"  data-toggle="modal" data-target="#lightboxTempModal" data-backdrop="static" data-keyboard="false">
                     <i class="icon-show"></i>
                     </a>
                  </div>
