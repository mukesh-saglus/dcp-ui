	...
	<div class="row">
		<div class="col-12 text-center blank-page-h d-flex align-items-center">
			<div class="w-100 d-gblue-clr">
				<div class="f-50"><i class="icon-add-new-campaign"></i></div>
				<p class="mt5">Create a campaign to get started</p>
				<div class="mt20"><a href="javascript:void(0)" data-toggle="modal" data-target="#AddNewCampaignsModal" class="base-btn blue-btn">&nbsp;&nbsp;<i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Campaign&nbsp;&nbsp;</a></div>
          </div>
		</div>
	</div>
	<!------ Blank Setion End---------->
