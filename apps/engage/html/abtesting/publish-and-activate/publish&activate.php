...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30">
		<div class="col-12">
			...
			<p class="f-14 w400 gblue-clr">Publish and activate your A/B test campaign</p>
		</div>
	</div>
	<!------- Header End ----------->
						...
						<div class="smart-form row">
							<div class="col-12 col-md-9 col-lg-9"> 
                            	...
                            	<div class="col-12 col-md-7 col-lg-6 col-xl-4">
                                	<div class="form-group d-gblue-clr Facebook-dropdown mb0">
                                ...
                                <div class="col-12 col-md-5 col-lg-6 col-xl-8 mt15 mt-md0">
    ...
    <!---------- Where to show Campaign Section --------->
					...
					<div id="collapsewebsite" class="collapse">
						<div class="card-body">
							<div class="row mb15 mb-md20">
								<div class="col-12 col-md-8 col-lg-9"><div class="d-flex justify-content-start flex-wrap d-gblue-clr">
						...
						<div id="SpecificLocation">
							<div class="row">
								<div class="col-md-10 col-12 col-lg-10 d-gblue-clr d-flex flex-wrap p0 smart-form">
									...
									<div class="align-self-center  mt18 mt-md0"><a class="d-gblue-clr segment-delete f-16 t-decoration-none" href="#"><i class="icon-delete"></i></a></div>
								</div>

								<div class="col-12 col-md-2 col-lg-2 mt10 mt-md0">
									<a href="#" class="base-btn normal-btn-outline px10 py3 f-12 pull-right">Reset</a>
								</div>
							</div>
    ...
    <!---------- End Where to show Campaign Section --------->
    
    
    <!---------- How to show Campaign Section --------->
    <div class="row mt-md30 mt15">
					...
					<div id="collapseOption" class="collapse">
                    	...
                    	<div class="smart-form row">
							<div class="col-12 col-md-10 col-lg-9"> 
                            	<div class="f-14 d-gblue-clr mb8">Varient A</div>
                            	<div class="row">                              
                                    <div class="col-12 col-md-5 col-lg-5 col-xl-4">
                                    <div class="form-group d-gblue-clr mb0 onselectoption">
                                        <select class="selectpicker" title="On Scroll">
                                            <option value="onlanding">On Landing</option>
                                            <option value="onexit">On Exit</option>
                                            <option value="ondelay">On Delay</option>
                                            <option value="onscroll">On Scroll</option>
                                        </select> 
                                    </div>
                                    </div>
                                	<div class="col-9 col-md-5 col-lg-5 col-xl-4 mt15 mt-md0"><span class="ondelay timeshow">
                                        <input type="text" class="form-control" value="" placeholder="00:35"/></span>  
										<span class="onscroll timeshow">
                                        <input type="text" class="form-control" value="" placeholder="10%"/></span> 
                                    </div>
                                    <div class="col-3 col-md-2 col-lg-2 col-xl-2 d-flex align-items-center pl0 mt10 mt-md0 d-gblue-clr">
									<span class="ondelay timeshow">(In Sec)</span>
									<span class="onscroll timeshow">(In %)</span></div>
                                </div>                         
							</div>
							<div class="col-12 col-md-2 col-lg-3 mt10 mt-md0 d-none d-md-block">
								<a href="#" class="base-btn normal-btn-outline px10 py3 f-12 pull-right">Reset</a>
							</div>
						</div>
                        ...
                        <div class="smart-form row">
							<div class="col-12 col-md-10 col-lg-9"> 
                            	<div class="f-14 d-gblue-clr mb8">Varient B</div>
                            	<div class="row">                              
                                    <div class="col-12 col-md-5 col-lg-5 col-xl-4">
                                    <div class="form-group d-gblue-clr mb0 onselectoption1">
                                        <select class="selectpicker" title="On Scroll">
                                            <option value="onlanding1">On Landing</option>
                                            <option value="onexit1">On Exit</option>
                                            <option value="ondelay1">On Delay</option>
                                            <option value="onscroll1">On Scroll</option>
                                        </select>
                                    </div>
                                    </div>
                                	<div class="col-8 col-md-5 col-lg-5 col-xl-4 mt15 mt-md0">
                                        <span class="ondelay1 timeshow1">
                                        <input type="text" class="form-control" value="" placeholder="00:35"/></span>  
										<span class="onscroll1 timeshow1">
                                        <input type="text" class="form-control" value="" placeholder="10%"/></span>    
                                    </div>
                                    <div class="col-4 col-md-2 col-lg-2 col-xl-2 d-flex align-items-center pl0 mt10 mt-md0 d-gblue-clr">
										<span class="ondelay1 timeshow1">(In Sec)  <a href="javascript:" class="d-gblue-clr t-decoration-none ml10 ml-md15"><i class="icon-refresh"></i></a></span>
									<span class="onscroll1 timeshow1">(In %)<a href="javascript:" class="d-gblue-clr t-decoration-none ml10 ml-md15"><i class="icon-refresh"></i></a></span>
										
									</div>
                                </div>                         
							</div>
							<div class="col-12 col-md-2 col-lg-3 mt10 mt-md0 d-block d-md-none">
								<a href="#" class="base-btn normal-btn-outline px10 py3 f-12 pull-right">Reset</a>
							</div>
						</div>
						</div>	
        ...
        <div class="col-12 segment-accordion mt-md20 mt15">
			<div id="accordion" class="accordion">
				<div class="card mb-0 f-16">
					<div class="card-header collapsed" data-toggle="collapse" href="#collapseEntryExitanim">
					...
					<div id="collapseEntryExitanim" class="collapse">
						<div class="card-body">
                    	<div class="smart-form row">
							<div class="col-12 col-md-10 col-lg-9"> 
                            	<div class="f-14 d-gblue-clr mb8">Varient A</div>
                            	<div class="row">                              
                                	...
                                	<div class="col-12 col-md-5 col-lg-5 col-xl-4 mt15 mt-md0">
                                        <div class="form-group d-gblue-clr mb0">
                        ...
                        <div class="smart-form row">
							<div class="col-12 col-md-10 col-lg-9"> 
                            	...
                            	<div class="row">                              
                                	...
                                	<div class="col-9 col-md-5 col-lg-5 col-xl-4 mt15 mt-md0">
                                    	<div class="form-group d-gblue-clr mb0">
                                            <select class="selectpicker" title="Select exit animation" data-live-search="true">
                     						<option value='bounce'> Bounce    </option>
											<option value='bounceOut' >Bounce out    </option>
                                    ...
                                    <div class="col-3 col-md-2 col-lg-2 col-xl-2 d-flex align-items-center pl0 mt10 mt-md0 d-gblue-clr"><a href="javascript:" class="d-gblue-clr t-decoration-none"><i class="icon-refresh"></i></a></div>
                                </div>                         
							</div>
							<div class="col-12 col-md-2 col-lg-3 mt10 mt-md0 d-block d-md-none">
								<a href="#" class="base-btn normal-btn-outline px10 py3 f-12 pull-right">Reset</a>
    ...
    <!---------- End How to show Campaign Section --------->
	...
	<!---------- campaign is shown to visitor Section --------->
	<div class="row mt-md30 mt15">
		<div class="col-12 f-18 w400">
        Maximum number of times this campaign is shown to visitor?</div>
		<div class="col-12 segment-accordion mt-md20 mt15">
			<div id="accordion" class="accordion">
				<div class="card mb-0">
					<div class="card-header collapsed" data-toggle="collapse" href="#collapseMaxLimit">
						<a class="card-title f-16 lato-font">&nbsp; Set maximum limits</a>
					</div>
					...
					<div id="collapseMaxLimit" class="collapse set-time-drop f-14">
						<div class="card-body">
						<div class="row">
	...
	<!---------- End campaign is shown to visitor Section --------->
	...
	<div class="row mt-md30 mt15">
        ...
        <!------ Campaign start date and time Section ------>
		<div class="col-12 segment-accordion mt-md20 mt15">
			<div id="accordion" class="accordion">
				<div class="card mb-0">
					<div class="card-header collapsed" data-toggle="collapse" href="#collapsePublish">
						<a class="card-title f-16 lato-font">&nbsp; Campaign start date and time</a>
					</div>
							...
							<div class="f-14 vd-gblue-clr">Campaign end date</div>
								...
								<div id="Testingenddate" class="mt15">
									<div class="d-flex smart-form justify-content-start flex-wrap align-items-center">
										<div class="col-xl-4 col-md-5 col-12 pl0 pr0 pr-md15">
											<div class="input-group calendar-input-group mb10 mb-md0">
												<input type="text" class="caleran-ex-left1 form-control f-14 " id="target-cal" readonly data-plugin-options='{"rangeOrientation":true,"showButtons":true}' placeholder="Choose Date"/>
       ...
       <!------ Set campaign frequency Section ------>
		<div class="col-12 segment-accordion mt-md20 mt15">
			<div id="accordion" class="accordion">
				<div class="card mb-0">
			...
			<div id="accordion" class="accordion">
				<div class="card mb-0">
					<div class="card-header collapsed  f-16" data-toggle="collapse" href="#collapsewinner">
					 ...
					 <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Decide a winner of your A/B test based on selected attributes." class="pull-right d-gblue-clr segment-info"><i class="icon-information"></i></a> 
					<div id="collapsewinner" class="collapse">
						...
						<div class="row mt-md25">
							<div class="col-md-12 col-12 col-lg-12 d-gblue-clr">
							<label class="f-14">Winning date</label>	
									<div class="d-flex smart-form justify-content-start flex-wrap align-items-center">
										<div class="col-12 col-md-4 col-lg-4 col-xl-3 pl0 pr0 pr-md15">
											<div class="input-group calendar-input-group mb10 mb-md0">
												<input type="text" class="caleran-ex-left4 form-control f-14 " id="target-cal" readonly data-plugin-options='{"rangeOrientation":true,"showButtons":true}' placeholder="Choose Date"/>
