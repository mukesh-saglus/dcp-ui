...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		...
		<div class="col-12 col-md-6 col-lg-5 text-center text-md-right mt10 mt-md0 f-16 w400">
			...
			<a href="javascript:" class="base-btn blue-btn" data-toggle="modal" data-target="#addnewabTestModal" ><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp;  New A/B Test</a>
		</div>
	...
	<div class="row mb15 mb-md30 min-h-40 relative">
		...
		<div class="d-flex flex-wrap">
			...
			<span class="bs-h40 table-option-hide col-12 col-md-9 col-lg-9 col-xl-6 mt15 mt-md0 px0 px-md15">
                <select class="selectpicker f-14" title="All A/B Test (400)">
                  <option>All A/B Test (400)</option>
				  ...
				  <option>A/B Test added in last 30 days (10)</option>
				</select>
			</span>
		</div>
		</div>
							...
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-5 col-lg-6 col-md-12 col-12 pr-md15">
									<div class="d-flex align-items-center">
									   <div class="f-20 f-md-24 w400 text-ellipsis">A/B Test Title </div><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-16"></i></a>
									</div>
					...
					<div class="row">
						...
						<div class="col-12 col-md-8 col-lg-9 col-xl-9 mt15 mt-md0 d-flex flex-wrap">
							<div class="row hide-edit-show no-gutters w-100">
								...
								<button class="f-12 live-btn campaign-active inactive-btn"><i class="icon-enable"></i>&nbsp;&nbsp;<span>Inactive</span></button>
