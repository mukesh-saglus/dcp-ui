...
<div class="container-middle min-h100 text-center">
	    <div class="row w-100">
			<div class="col-12">
				<img src="../../../../images/404.png" class="img-fluid d-block mx-auto">
				<div class="my15 f-16">Sorry, the page you're looking for cannot be found</div>
				<a href="#" class="base-btn blue-btn" title="Go to Dashboard">Go to Dashboard</a>
			</div>
		</div>
</div>	
