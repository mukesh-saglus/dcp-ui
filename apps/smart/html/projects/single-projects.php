...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		<div class="col-12 col-md-7 col-lg-7">
			...
			<p class="f-14 mt5 gblue-clr">Here you can create & manage your all projects</p>
		</div>
		<div class="col-12 col-md-5 col-lg-5 text-center text-md-right mt10 mt-md0 f-16 w400">
			...
			<a href="javascript:void(0)" class="base-btn blue-btn"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Page</a>
		</div>
	</div>
	<!------- Header End ----------->
	<!--- Filteration Div ---->
	<div class="row mb-xl30 mb15 min-h-40 relative">
		...
		<!----- Table Option Div end---->
       	<div class="col-md-12 col-lg-5 col-xl-6 align-items-center mb-lg0 mb15 pr-md0">
			<div class="d-flex flex-wrap">
				...
				<div class="bs-h40 table-option-hide col-12 col-md-5 col-lg-5 col-xl-5 mt15 mt-md0 px0 px-md15">
				...
				<div class="bs-h40 table-option-hide col-12 col-md-6 col-lg-5 col-xl-5 mt15 mt-md0 px0 px-md15">
					<select class="selectpicker f-14" title="All Pages (100)">
					  <option>All Pages (100)</option>
					  <option>Recently Added Pages (50)</option>
					  <option>Recently Modified Pages (20)</option>
					  <option>Pages Added In last 07 Days (10)</option>
					  <option>Pages Added In Last 30 Days (30)</option>
					</select>
				</div>
			</div>
		</div>
		<div class="col-md-12 col-lg-7 col-xl-6 smart-form table-option-hide">
			<div class="row">
				...
				<div class="col-md-4 col-lg-5 col-xl-5 mb15 mb-md0 pl-md0 pl-lg15">
						  ...
						  <div class="media">
							 ...
							 <div class="media-body ml5">
								<div class="hover-img d-flex align-items-center">
								   <img src="<?php echo $basedir; ?>images/template.png" class="img-fluid d-block mx-auto">
							...
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-5 col-lg-6 col-md-12 col-12 pr-md15">
                                    ...
                                    <div class="f-14 d-gblue-clr my10 my-md10">
										...
										<p class="lh150">
										<span>Start Date: 24 Nov 2018 at 5:00 PM</span><br/>
										<span>End Date: 12 Dec 2018 at 4:08 PM</span>
										</p>
									</div>
									<span class="f-12 live-btn"><i class="icon-enable"></i> &nbsp;&nbsp;Active</span>
									<div class="mt15 f-14">Industry Name</div>
								</div>
								<div class="col-xl-7 col-lg-6 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
									...
									<div class="col-12 text-md-right p0 align-self-end">
										<ul class="list-inline w400 mt-xl20 mb0">
											...
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="View Report"><i class="icon-report"></i><span class="hide-text-md">&nbsp;  View Report</span></a>
											</li>
											<li class="list-inline-item mt10 dropdown simple-dropdown caret-icon-none">
												<a href="#" class="base-btn default-btn btn-h30 f-14 dropdown-toggle l-gblue-clr" data-toggle="dropdown">
					...
					<div class="col-12 col-md-4 col-lg-3 col-xl-3">
						...
						<div class="col-12 col-md-8 col-lg-9 col-xl-9 mt15 mt-md0 d-flex flex-wrap">
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-5 col-lg-6 col-md-12 col-12 pr-md15">
									<div class="d-flex align-items-center">
										<div class="f-20 f-md-24 w400 text-ellipsis">Video Name Goes Here</div><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-16"></i></a>
									</div>
                                    <div class="f-14 d-gblue-clr my10 my-md10">
										<p class="lh150">Created on: Nov 18, 2017 at 4:08 PM
										</p>
									</div>
								</div>
								<div class="col-xl-7 col-lg-6 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
									<div class="d-flex justify-content-between flex-wrap w-100">
										...
										<div class="d-flex">
											<img class="img-fluid d-block mx-auto icon-width" src="<?php echo $basedir; ?>images/engagement-circle-icon.png">
											<div class="ml10">
												<span class="f-16">Engagement</span>
												<div class="f-24">2% </div>
											</div>
										</div>
									</div>
									...
									<div class="col-12 text-md-right p0 align-self-end">
										<ul class="list-inline w400 mt-xl20 mb0">
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="Manage"><i class="icon-settings"></i><span class="hide-text-md">&nbsp;  Manage</span></a>
											</li>
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="View Report"><i class="icon-report"></i><span class="hide-text-md">&nbsp;  View Report</span></a>
											</li>
											<li class="list-inline-item mt10"><a data-toggle="modal" data-target="#lightboxTempModal" data-backdrop="static" data-keyboard="false" class="base-btn default-btn btn-h30 f-14" title="View"><i class="icon-preview"></i><span class="hide-text-md">&nbsp;  Preview</span></a>
											</li>
											<li class="list-inline-item mt10 dropdown simple-dropdown caret-icon-none">
												<a href="#" class="base-btn default-btn btn-h30 f-14 dropdown-toggle l-gblue-clr" data-toggle="dropdown">
												<span data-toggle="tooltip" data-placement="top" title="" data-original-title="More"><i class="icon-more"></i></span>
						...
						<div class="col-12 col-md-8 col-lg-9 col-xl-9 mt15 mt-md0 d-flex flex-wrap">
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-5 col-lg-6 col-md-12 col-12 pr-md15">
									...
									<span class="f-12 live-btn"><i class="icon-pending"></i> &nbsp;&nbsp;In Process</span>
								</div>
								<div class="col-xl-7 col-lg-6 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
									<div class="d-flex justify-content-between flex-wrap w-100">
										<div class="d-flex mr15 mr-md20">
									...
									<div class="col-12 text-md-right p0 align-self-end">
										<ul class="list-inline w400 mt-xl20 mb0">
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="Manage"><i class="icon-paused f-10"></i><span class="hide-text-md">&nbsp;  Pause</span></a>
											</li>
											<li class="list-inline-item mt10"><a href="#" class="base-btn default-btn btn-h30 f-14" title="View Report"><i class="icon-report"></i><span class="hide-text-md">&nbsp;  View Report</span></a>
											</li>
