	...
	<div class="row">
		...
		<div class="col-xl-10 col-lg-9 col-md-9 col-12">
			...
			<ul class="nav nav-tabs thirdparty-navs nav-justified w-100" role="tablist">
			  <li class="nav-item">
				<a class="nav-link active" href="#pixabay" role="tab" data-toggle="tab"><img class="img-fluid d-block mx-auto" src="<?php echo $basedir; ?>images/my-drive-pixabay.png"></a>
			  </li>
			  <li class="nav-item">
			  ...
			  <li class="nav-item">
				<a class="nav-link" href="#googledrive" role="tab" data-toggle="tab"><img class="img-fluid d-block mx-auto" src="<?php echo $basedir; ?>images/my-drive-googledrive.png"></a>
			  </li>
			  <li class="nav-item">
			...
			<!--- Filteration Div ---->
			<div class="row mb15 align-items-center mb-md30">
			    ...
			    <div role="tabpanel" class="tab-pane active" id="pixabay">
