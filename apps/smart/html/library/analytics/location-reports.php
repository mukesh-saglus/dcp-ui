			...
			<div class="col-12 col-md-12 col-lg-4 mt20 mt-lg10">
				<div class="row small-radio-btn">
					...
					<div class="smart-radio-btn text-truncate radio-strong-yellow col-md-6 col-12">
						...
						<label class="mb-lg20" for="Conversion" onclick="updatePieChart('conversionpie')"> Visitors </label>
					...
					<div class="smart-radio-btn text-truncate radio-strong-purple col-md-6 col-12">
						...
						<label for="UniqueAudience" onclick="updatePieChart('uaudiencepie')"> Contacts </label>
					</div>
	...
	<div class="col-12 p0 mt15 mt-md50">
		...
		<!---- Country City Data Table --------->
			...
			<div class="col-12 col-md-12 col-lg-4 mt20 mt-lg10">
				<div class="row small-radio-btn">
					<div class="smart-radio-btn text-truncate radio-strong-blue col-md-6 col-12">	
						<input name="locationmap1" id="Audience1" value="option1" checked="" type="radio">
						<label class="mb-lg20" for="Audience1" onclick="updatecityPieChart('topcitiespie')"> Visits </label>
					</div>
					<div class="smart-radio-btn text-truncate radio-strong-yellow col-md-6 col-12">
						<input name="locationmap1" id="Conversion1" value="option1" type="radio">
						<label class="mb-lg20" for="Conversion1" onclick="updatecityPieChart('citiesconversionpie')"> Visitors </label>
					</div>
					<div class="smart-radio-btn text-truncate radio-strong-purple col-md-6 col-12">
						<input name="locationmap1" id="UniqueAudience1" value="option1" type="radio">
						<label for="UniqueAudience1" onclick="updatecityPieChart('citiesuaudiencepie')"> Contacts </label>
					</div>
