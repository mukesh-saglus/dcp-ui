		...
		<form>  	
			...
			<div class="mt-md30 mt15">
				<div class="d-flex align-items-center justify-content-between">
					<label class="d-gblue-clr">Business Name</label> 
					<a href="business-profile.php" class="t-decoration-none d-gblue-clr mb5"><i class="icon-edit f-12"></i></a>
				</div>
				<input class="form-control f-14 field-h40" type="text" value="XYZ Pvt Ltd" placeholder="Enter Main Headline" disabled>
				</div>
			<div class="business-logo-img align-items-center d-flex justify-content-center mt-md30 mt15">
			...
			<div class="mt-md30 mt15">
				...
				<textarea class="form-control" rows="5" placeholder="Type here" disabled>Rangbari Main Road, 
India, Rajasthan,
Kota, (Pin-324005)</textarea>
			</div>
