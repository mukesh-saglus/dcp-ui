...
<div class="container-fluid p15 p-md30">
	<div class="row align-items-center">
		...
		<span class="f-20 f-md-24 lato-font">Email Templates </span> &nbsp;
		<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
		<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#vhelpModal"><i class="icon-video-help"></i></a>
		<p class="d-gblue-clr w400 mt5">Here you can create &amp; manage all your accounts</p>
		</div>
		<div class="col-12 col-md-7 col-lg-6 text-center text-md-right">
		<a href="#" class="base-btn blue-btn mt10 mt-md0"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Email Template</a>
		</div>
	</div>
		...
		<div class="col-12">            
			<div class="row smart-form bs-h40">
				<div class="col-12 col-md-4 col-lg-2 mb10 mb-lg0">
					<select class="selectpicker f-14" title="All Email Templates (200)">
						<option>All Email Templates (200)</option>
				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							...
							<td>FE0</td>
							<td>Trial Version</td>
							<td>Thank you for signing up for Xmails Free Trial </td>
							<td>
							...
							<li class="action-menu"><a href="#" data-toggle="modal" data-target="#TemplateDetails" class="action-item" title="View"><i class="icon-show"></i></a></li>
