...
<body>
<!------- Add Template Header Start----------->
<div class="blog-header py5 px15 px-md30">
	<div class="d-flex justify-content-between flex-wrap">
		<div class="f-14 align-self-center mb10 mb-md0">
			<a href="#" class="t-decoration-none white-clr"><i class="icon-back"></i>&nbsp;&nbsp; Add New Funnel</a>
		</div>
		<a href="#" class="base-btn green-btn f-14 restore-detail px-md40">Next</a>
	</div>
</div>
<!------- Add Template Header End ----------->