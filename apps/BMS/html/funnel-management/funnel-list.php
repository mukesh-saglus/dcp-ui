...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		<div class="col-12 col-md-6 col-lg-7">
			<span class="f-20 f-md-24 lato-font">All Funnels</span> &nbsp;
			<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
			<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#vhelpModal"><i class="icon-video-help"></i></a>
			<p class="f-14 mt5 gblue-clr">Here you can manage all the accounts in BMS</p>
		</div>
		<div class="col-12 col-md-6 col-lg-5 text-center text-md-right mt10 mt-md0 f-16 w400">
			<a href="add-funnel.php" class="base-btn blue-btn"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp;  Add Funnel</a>
		</div>
	</div>
	<!------- Header End ----------->
	<!--- Filteration Div ---->
	<div class="row mb-xl30 mb15 min-h-40 relative">
		<div class="table-option-manage manage animated fadeIn ml10 col-12 pt5">
		...
		<div class="col-md-10 col-lg-11 col-xl-11 mt20 mt-md0 smart-form table-option-hide">
			<div class="row">
				<div class="col-md-6 col-lg-3 col-xl-2 bs-h40 mb10 mb-lg0">
				...
				<div class="col-md-6 col-lg-2 col-xl-2 bs-h40 mb10 mb-lg0">
					<select class="selectpicker f-14" title="All Funnels (100)">
						<option>All Funnels (100)</option>
						<option>Recently Added Funnels (50)</option>
						<option>Recently Modified Funnels (20)</option>
						<option>Funnels Added In last 07 Days (10)</option>
						<option>Funnels Added In Last 30 Days (30)</option>
					</select>
				</div>
							...
							<div class="row hide-edit-show no-gutters w-100">
								<div class="col-xl-5 col-lg-6 col-md-12 col-12 pr-md15">
									<div class="d-flex align-items-center">
									   <div class="f-20 f-md-24 w400 text-ellipsis">Funnel Name</div><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-16"></i></a>
									</div>
                                    <div class="f-14 d-gblue-clr my10 my-md10">
										<p class="lh150">Total Page: 12</p>
									...
									<div class="mt15 f-14">Industry Name , Use Case Name </div>
								</div>
