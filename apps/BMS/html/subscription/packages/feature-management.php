...
<div class="container-fluid p15 p-md30">
	...
	<div class="row">
		<div class="col-12 mb15 mb-md30">
			<span class="f-20 f-md-24 lato-font">Feature Management</span> &nbsp;
						...
						<div class="card-body smart-form d-gblue-clr f-14">
							...
							<div class="row mt-md20 mt15">
								<div class="col-12 col-md-8 col-xl-6 text-right">
									<a href="#" class="base-btn blue-btn">Fetch Features</a>
								</div>
							</div>
						</div>	
					</div>
			...
			<div id="accordion" class="accordion">
				<div class="card mb-0 f-16">
					<div class="card-header collapsed" data-toggle="collapse" href="#SmartNotification">
						<a class="card-title lato-font">&nbsp; Popups & Sticky Bars</a>
					</div>
					 <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Some Info Text Here" class="pull-right d-gblue-clr segment-info"><i class="icon-information"></i></a> 
						...
						<div class="card-body">
							<div class="row mb-md30 mb10">
								...
								<div class="col-12">
									...
									<label for="PopupsSticky Bars" class="w500">Popups & Sticky Bars</label>
									</div>
								</div>
							</div>
							<div class="row mb10 mb-md30">
								<div class="col-12 col-lg-3 col-md-4 mb10">
									...
									<label for="OwnNotification">Create Your Popups & Sticky Bars</label>
									</div>
								</div>
								<div class="col-12 col-lg-3 col-md-4 mb10">
									<div class="smart-checkbox-btn checkbox-strong-blue d-flex ml5">
							...
							<div class="row mb10 mb-md30">
								...
								<div class="col-12 col-lg-3 col-md-4 mb10">
									...
									<label for="popuppage">Download Popups & Sticky Bars</label>
									</div>
								</div>
								<div class="col-12 col-lg-3 col-md-4 mb10">
									<div class="smart-checkbox-btn checkbox-strong-blue d-flex ml5">
							...
							<div class="row mb-md30 mb10">
								<div class="col-12 mb10">
									...
									<label for="PublishWebNotification" class="w500">Publish Popups & Sticky Bars</label>
									</div>
								</div>
								<div class="col-12 col-lg-3 col-md-4 mb10">
									<div class="smart-checkbox-btn checkbox-strong-blue d-flex ml5">
							...
							<div class="row mb10">
								<div class="col-12 mb10">
									...
									<label for="Analytics4" class="w500">Analytics (Popups & Sticky Bars & A/B Test)</label>
									</div>
								</div>
								<div class="col-12 col-lg-3 col-md-4 mb10">
									<div class="smart-checkbox-btn checkbox-strong-blue d-flex ml5">
