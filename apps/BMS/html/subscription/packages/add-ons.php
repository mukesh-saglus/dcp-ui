		...
		<div class="row">
			<div class="col-12 col-md-10 col-xl-11">
				<div class="card mb-0 f-16">
					<div class="card-header" data-toggle="collapse" href="#AddOn2" aria-expanded="true">
					...
					<div id="AddOn2" class="collapse show" data-parent="#accordion">
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-12 col-12 mt15 mt-md30">
									<div class="row align-items-center">
										...
										<div class="col-12 col-md-5 mt15 mt-md0">
										<input type="text" class="form-control" placeholder="AB Page" value="50">
										</div>
										<div class="col-12 col-md-3 mt10 mt-md0">
											<div class="label-active smart-checkbox-btn checkbox-strong-blue d-flex float-right float-md-left">
											<input id="ABPage" type="checkbox">
											<label for="ABPage" class="mb0 l-gblue-clr">Unlimited</label>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-12 col-12 mt15 mt-md30">
									<div class="row align-items-center">
										...
										<div class="col-12 col-md-5 mt15 mt-md0">
										<input type="text" class="form-control" placeholder="AB Popups & Bars" value="50">
										</div>
										<div class="col-12 col-md-3 mt10 mt-md0">
											<div class="label-active smart-checkbox-btn checkbox-strong-blue d-flex float-right float-md-left">
											<input id="ABPopupsBars" type="checkbox">
											<label for="ABPopupsBars" class="mb0 l-gblue-clr">Unlimited</label>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-12 col-12 mt15 mt-md30">
									<div class="row align-items-center">
										...
										<div class="col-12 col-md-5 mt15 mt-md0">
										<input type="text" class="form-control" placeholder="AB Mail" value="50">
										</div>
										<div class="col-12 col-md-3 mt10 mt-md0">
											<div class="label-active smart-checkbox-btn checkbox-strong-blue d-flex float-right float-md-left">
											<input id="ABMail" type="checkbox">
											<label for="ABMail" class="mb0 l-gblue-clr">Unlimited</label>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-12 col-12 mt15 mt-md30">
									<div class="row align-items-center">
										...
										<div class="col-12 col-md-3 mt10 mt-md0">
											<div class="label-active smart-checkbox-btn checkbox-strong-blue d-flex float-right float-md-left">
											<input id="ABPage1" type="checkbox">
											<label for="ABPage1" class="mb0 l-gblue-clr">Unlimited</label>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-12 col-12 mt15 mt-md30">
									<div class="row align-items-center">
										...
										<div class="col-12 col-md-3 mt10 mt-md0">
											<div class="label-active smart-checkbox-btn checkbox-strong-blue d-flex float-right float-md-left">
											<input id="ABPopupsBars1" type="checkbox">
											<label for="ABPopupsBars1" class="mb0 l-gblue-clr">Unlimited</label>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-6 col-md-12 col-12 mt15 mt-md30">
									<div class="row align-items-center">
										...
										<div class="col-12 col-md-3 mt10 mt-md0">
											<div class="label-active smart-checkbox-btn checkbox-strong-blue d-flex float-right float-md-left">
											<input id="ABMail1" type="checkbox">
											<label for="ABMail1" class="mb0 l-gblue-clr">Unlimited</label>
											</div>
										</div>
									</div>
								</div>
