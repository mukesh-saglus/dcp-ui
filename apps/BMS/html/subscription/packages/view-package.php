...
<div class="container-fluid p15 p-md30">
	...
	<div class="row align-items-center mb15 mb-md30">
		<div class="col-12">
         ...
         <p class="f-14 gblue-clr w400">Check out your Package details</p>
      </div>
	</div>
	<div class="row">	
			...
			<div id="accordion" class="accordion">
				<div class="card mb-0 f-16">
					<div class="card-header card-header-icon-remove d-flex align-items-center flex-wrap px20 px-md30">
						<div class="card-title current-plan-card-title mb-md0">
						...
						<span class="f-14 px15 ml-sm-auto">Updated On: 18 Mar 2019 at 10:41 PM</span>
