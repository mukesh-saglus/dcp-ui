					...
					<div id="journeytab" class="collapse">
						<div class="card-body">
							...
							<div class="row mb-md30 mb10">
								...
								<div class="col-12 col-lg-3 col-md-4 mb10">
									<div class="smart-checkbox-btn checkbox-strong-blue d-flex ml5">
									<input id="LandingPages" class="checkbox-active" type="checkbox">
						...
						<div class="card-body">
							...
							<div class="row mb10">
								<div class="col-12 col-lg-3 col-md-4 mb10">
									...
									<label for="OwnNotification" class="w500">Create Your Own Popups & Bars</label>
									</div>
								</div>
								<div class="col-12 col-lg-3 col-md-4 mb10">
									<div class="smart-checkbox-btn checkbox-strong-blue d-flex ml5">
								...
								<div class="col-12 col-lg-3 col-md-4 mb10">
									...
									<label for="DuplicateCampaign" class="w500">Duplicate Campaign</label>
									</div>
								</div>
								<div class="col-12 col-lg-3 col-md-4 mb10">
									<div class="smart-checkbox-btn checkbox-strong-blue d-flex ml5">
									<input id="SaveasTemplate" class="checkbox-active" type="checkbox">
									<label for="SaveasTemplate" class="w500">Save as Template</label>
									</div>
								</div>
							...
							<div class="row mb-md30 mb10">
								<div class="col-12 mb10">
									...
									<label for="PublishWebNotification" class="w500">Publish Web Popups & Bars</label>
									</div>
								</div>
								<div class="col-12 col-lg-3 col-md-4 mb10">
									<div class="smart-checkbox-btn checkbox-strong-blue d-flex ml5">
								...
								<div class="col-12 col-lg-3 col-md-4 mb10">
									<div class="smart-checkbox-btn checkbox-strong-blue d-flex ml5">
									<input id="Setmaximumlimits1" class="checkbox-active" type="checkbox">
									<label for="Setmaximumlimits1">Set maximum limits</label>
									</div>
								</div>
							</div>
							<div class="row mb10 mb-md30">
								...
								<div class="col-12 col-lg-3 col-md-4 mb10">
									...
									<label for="popuppage">Download Popups & Bars</label>
									</div>
								</div>
								<div class="col-12 col-lg-3 col-md-4 mb10">
									<div class="smart-checkbox-btn checkbox-strong-blue d-flex ml5">
							...
							<div class="row mb-md30 mb10">
								...
								<div class="col-12 col-lg-3 col-md-4 mb10">
									<div class="smart-checkbox-btn checkbox-strong-blue d-flex ml5">
									<input id="Setmaximumlimits2" class="checkbox-active" type="checkbox">
									<label for="Setmaximumlimits2">Set maximum limits</label>
									</div>
								</div>
							</div>
							<div class="row mb10">
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-12 col-lg-3 col-md-4 mb10">
									...
									<label for="DedicatedIPAddresses" class="w500">Dedicated IP Addresses</label>
									</div>
								</div>
							</div>	
						</div>	
