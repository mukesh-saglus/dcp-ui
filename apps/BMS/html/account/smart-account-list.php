...
<?php include '../../../smart/html/includes/bms-header-final.php'; ?>
...
<div class="container-fluid p15 p-md30">
	...
	<div class="row align-items-center">
		<div class="col-12 col-md-5 col-lg-6">
			<span class="f-20 f-md-24 lato-font">Accounts </span> &nbsp;
			<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
			<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#vhelpModal"><i class="icon-video-help"></i></a>
			<p class="d-gblue-clr w400 mt5">Here you are manage your all accounts details</p>
		</div>
		<div class="col-12 col-md-7 col-lg-6 text-center text-md-right">
			<a href="#" class="base-btn default-btn mt10  mt-md0 mr5">Import</a>
			<a href="#" class="base-btn default-btn  mt10 mt-md0 mr5">Export</a>
			<a href="#" class="base-btn blue-btn mt10 mt-md0" data-toggle="modal" data-target="#AddAccountModal"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Account</a>
		</div>
	</div>
	<!------ Header End---------->
	...
	<div class="row mt15 mt-md30">
		...
		<div class="col-12">            
			...
			<div class="col-md-4 col-lg-2 bs-h40 mb10 mb-lg0 smart-form">
				<select class="selectpicker f-14" title="Select Active Account">
				  <option>Active(25)</option>
				  <option>Inactive(10)</option>
				</select>
              </div>	
                    ...
                    <td><ul class="table-action">
                       ...
                       <li class="action-menu table-action-dropdown"> <a href="javascript:" class="dropdown-toggle action-item" data-toggle="dropdown">  <span data-toggle="tooltip" data-placement="top" title="More" data-original-title="More"><i class="icon-more"></i></span> </a>
                          <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li><a href="#">View Team Member</a></li>
                          </ul>
                        </li>
                      </ul></td>
                  </tr>
