			...
			<div id="accordion" class="accordion hidetab-icon">
				<div class="card mb-0 f-16">
					<div class="card-header radiusb0" href="#collapseurl">
					 ...
					 <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Select your business and type the profile name." class="pull-right d-gblue-clr segment-info"><i class="icon-information"></i></a> 
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-12 col-md-4 col-lg-3 mb10">
									...
									<label for="AudienceAnalytics">Audience Analytics</label>
									</div>
								</div>
								<div class="col-12 col-md-4 col-lg-3 mb10">
									<div class="smart-checkbox-btn checkbox-strong-blue d-flex ml5">
