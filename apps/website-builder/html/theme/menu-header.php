...
<body>
	<!----------- header Section---------->
	<div class="builder-menu-header py5 px15 px-md30">
		<div class="d-flex flex-wrap align-items-center">
			<div class="f-14 align-self-center">
				<a href="#" class="t-decoration-none white-clr"><i class="icon-back"></i>&nbsp;&nbsp;Menu List</a>
			</div>
			<a href="javascript:void(0);" class="ml-auto mr15 mr-md20 t-decoration-none f-18"><i class="icon-show d-gblue-clr"></i></a>
			<a href="#" class="base-btn green-btn f-14 px-md30">Save & Next</a>
	</div>
	</div>
	<!----------- header Section end---------->