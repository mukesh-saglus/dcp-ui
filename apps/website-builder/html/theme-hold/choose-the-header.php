...
<li class="nav-item">
	<a class="nav-link active lh110" href="choose-the-header.php">	
...
<div class="container-fluid p15 p-md30">	
	<div class="row align-items-center mb15 mb-md30">
		...
		<div class="col-12 col-md-8 col-lg-9">
			<div class="w500 f-16 f-md-18">All Headers</div>
	...
	<div class="row">
		<div class="col-12 col-md-4 col-lg-3 mb15 mb-md30">
			...
			<div class="mt10">
				<p class="f-14 f-lg-16 w500 text-truncate" title="Header Name">Header Name</p>
		...
		<div class="col-12 col-md-4 col-lg-3 mb15 mb-md30">
			<div class="template-theme-grid">
				<div class="template-theme-block">
					<img src="../../images/theme/header-thumbnail5.png" class="img-fluid d-block mx-auto">
					<!-- Hover Button -->
					<div class="template-theme-overlay">
						<div class="author-hover-icons">
							<a href="JavaScript:Void(0);" class="theme-hover-btn" title="View"><i class="icon-show"></i></a>
