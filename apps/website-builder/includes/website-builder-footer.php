...
<!------- DotCompal Website Builder Common modal Include File---------->
<?php include 'common-modals-website-builder.php'; ?>
<!------- DotCompal Website Builder Common modal Include File end ---------->
...
<script type='text/javascript' src="<?php echo $basedir; ?>apps/website-builder/js/website-builder-jquery.js"></script>
