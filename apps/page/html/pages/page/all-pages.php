...
<div class="container-fluid p15 p-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		<div class="col-12 col-md-6 col-lg-7">
			<span class="f-20 f-md-24 lato-font">All Pages </span> &nbsp;
			<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#helpModal"><i class="icon-text-help"></i></a>
			<a href="#" class="gblue-clr t-decoration-none f-17" data-toggle="modal" data-target="#vhelpModal"><i class="icon-video-help"></i></a>
			<p class="f-14 mt5 gblue-clr">Here you can create & manage your all pages</p>
		</div>
		<div class="col-12 col-md-6 col-lg-5 text-center text-md-right f-16 w400">
			...
			<a href="#!" data-toggle="modal" data-target="#createNewPageModal" class="base-btn blue-btn mt10 mt-md0"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Page</a>
		</div>
	...
	<div class="row mb15 mb-md30 min-h-40 relative">
		...
		<div class="col-md-5 col-lg-5 col-xl-6 align-items-center mb-md0 mb15 pr-md0">
		<div class="d-flex flex-wrap">
			...
			<span class="bs-h40 table-option-hide col-12 col-md-9 col-lg-9 col-xl-6 mt15 mt-md0 px0 px-md15">
				<select class="selectpicker f-14" title="All Pages (400)">
