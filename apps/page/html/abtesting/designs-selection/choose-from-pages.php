...
<div class="container-fluid p15 p-md30">
   ...
   <div class="row mb15 mb-md30">
      <div class="col-12">
         ...
         <p class="f-14 gblue-clr w400">Design your A/B test page your own or choose from our high converting templates</p>
      </div>
   </div>
   <!------- Header End ----------->
   ...
   <div class="row">
      <div class="col-md-4 col-lg-3 col-xl-2">
         <div class="nav flex-column nav-pills ui-vertical-tab f-16 w400 side-tab-fixed">
            <a class="nav-link active"  href="choose-from-pages.php"><i class="icon-total-visited-pages"></i>From Pages</a>
