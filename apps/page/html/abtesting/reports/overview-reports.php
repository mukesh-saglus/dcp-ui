...
<div class="container-fluid p15 px-md30 py-md30">
    <div class="row">
		<div class="col-12">
			...
			<p class="f-14 gblue-clr w400 mt5">Check results of your A/B test in details</p>
		</div>
    </div>
</div>
...
<!------- Visitors Overview Section Start----------->
	...
	<div class="row">
		...
		<div class="col-12 col-md-8 col-lg-9 mb15 mb-md0">
			<h4>Visits</h4>
			<p class="f-14 lh140 d-gblue-clr w400">Check visitors & conversions counts for the A/B test variant</p>
		</div>
...
<!-------Visitors Graph Section Start----------->
	...
	<div class="row">
		...
		<div class="col-12 col-md-8 col-lg-9 mb15 mb-md0">
			...
			<p class="f-14 lh140 d-gblue-clr w300">Check total vs. unique visitors from the elegant line graph</p>
		</div>
