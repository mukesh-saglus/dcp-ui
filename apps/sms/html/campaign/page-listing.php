...
<div class="container-fluid p15 px-md30 py-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		...
		<div class="col-12 col-md-5 f-16 text-center text-md-right">
			...
			<a href="javascript:void(0)" class="base-btn blue-btn mt10 mt-md0" data-toggle="modal" data-target="#createNewPageModal"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Page</a>
		</div>
	</div>
	<!-- Header End  -->
	<div class="row">
				...
				<div class="col-12 col-md-11 bs-h40 table-option-hide pl-md0 col-xl-width2">
					<div class="row">
						<div class="col-12 col-md-4 col-xl-2 mt15 mt-md0">
							<select class="selectpicker" title="All Pages (400)">
								<option>All Pages (400)</option>
								<option>Recently added Page (10)</option>
								<option>Recently modified Page (15)</option>
								<option>Page added in last 07 days (10)</option>
								<option>Page added in last 30 days (10)</option>
							</select>
						</div>
									...
									<div class="row hide-edit-show no-gutters w-100">
										<div class="col-xl-6 col-lg-5 col-md-12 col-12 pr-md15">
											<div class="d-flex align-items-center">
												<div class="f-18 f-md-20 w500 text-ellipsis">Page Name Goes Here </div><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-12"></i></a>
											</div>
											<div class="d-gblue-clr mb5">
												<p class="lh150 f-13">Created on: 17 Feb 2020 at 4:08 PM</p>
											</div>
											<button class="campaign-active campaign-list-active mr10"><i class="icon-enable d-inline-block mt2"></i>&nbsp;&nbsp;<span>Active</span></button>
											<span class="f-12 campaign-list-private"><i class="icon-person f-10"></i> Private</span>
											<div class="mt15 f-14">Used in Journey : Journey name</div>
											<div class="mt10 f-14">Projec Name : DotcomPal</div>
										</div>
										<div class="col-xl-6 col-lg-7 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">

											<div class="d-flex justify-content-between flex-wrap w-100">
												<div class="d-flex mr10">
													<div class="campaign-list-icon"><i class="icon-audience-filll"></i></div>
													<div class="ml10">
														<span class="f-15">Audience</span>
												...
												<ul class="list-inline w400 mb0">
													...
													<li class="list-inline-item mt10 mt-md15 dropdown simple-dropdown caret-icon-none">
														...
														<ul class="dropdown-menu dropdown-menu-right mCustomScrollbar f-14" data-mcs-theme="inset-3" aria-labelledby="dropdownMenu1">
															<li> <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#versioncontrolModal">Revision History</a>
															</li>
					...
					<div class="border radius5 relative">
						...
						<div class="filter-scrollbar mCustomScrollbar" data-mcs-theme="inset-3">
							...
							<div class="clearfix filter-divide-bg">
								...
								<div class="form-group mb0">
									<select class="selectpicker mt5 f-14" title="Public">
										<option>Public</option>
										<option>Private</option>
										<option>Password Protected</option>
										<option>Live</option>
