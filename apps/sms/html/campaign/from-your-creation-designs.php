   ...
   <div class="row">
      <div class="col-md-4 col-lg-3 col-xl-2">
         <div class="nav flex-column nav-pills ui-vertical-tab f-16 w400 side-tab-fixed">
            <a class="nav-link"  href="from-gallery.php"><i class="icon-gallery"></i>From Gallery</a>
            <a class="nav-link active"  href="from-your-creation-designs.php"><i class="icon-your-creation"></i>From My Templates</a>
         </div>
      </div>
