...
<div class="container-fluid p15 p-md30">
    ...
    <div class="row contact-manually-group">
        <div class="col-12 col-md-6 col-lg-6 col-xl-6 mb15 mb-md30">
            <div class="subscribers-section radius3 h-100">
                <div class="title-header f-16 lato-font w400 p15 px-md20 d-flex align-items-center"><i class="icon-add-third f-20 s-green-clr white-bg d-inline-block rounded-circle mr12"></i>Include List</div>
        ...
        <div class="col-12 col-md-6 col-lg-6 col-xl-6 mb15 mb-md30">
            <div class="subscribers-section radius3 h-100">
                <div class="title-header f-16 lato-font w400 p15 px-md20 d-flex align-items-center"><i class="icon-add-third f-20 s-green-clr white-bg d-inline-block rounded-circle mr12"></i>Include Tags</div>
        ...
        <!--<div class="col-12 col-md-6 col-lg-6 col-xl-6 mb15 mb-md30">
            <div class="subscribers-section radius3 h-100">
                <div class="title-header f-16 lato-font w400 p15 px-md20 d-flex align-items-center"><i class="icon-add-third f-20 s-green-clr white-bg d-inline-block rounded-circle mr12"></i>Suppression List</div>
        ...
        <div class="col-12 col-md-6 col-lg-6 col-xl-6 mb15 mb-md0">
            <div class="subscribers-section radius3 h-100">
                <div class="title-header f-16 lato-font w400 p15 px-md20 d-flex align-items-center"><i class="icon-exclude f-20 vi-red-clr white-bg d-inline-block rounded-circle mr12"></i>Exclude List</div>
        ...
        <div class="col-12 col-md-6 col-lg-6 col-xl-6">
            <div class="subscribers-section radius3 h-100">
                <div class="title-header f-16 lato-font w400 p15 px-md20 d-flex align-items-center"><i class="icon-exclude f-20 vi-red-clr white-bg d-inline-block rounded-circle mr12"></i>Exclude Tags</div>
    ...
    <div class="row quick-mailing-group d-none">
        <div class="col-12 col-md-6 mb15 mb-md0">
            <div class="subscribers-section radius3 h-100">
                <div class="title-header f-16 lato-font w400 p15 px-md20 d-flex align-items-center"><i class="icon-add-third f-20 s-green-clr white-bg d-inline-block rounded-circle mr12"></i>Include Quick Mailing Group</div>
        ...
        <div class="col-12 col-md-6">
            <div class="subscribers-section radius3 h-100">
                <div class="title-header f-16 lato-font w400 p15 px-md20 d-flex align-items-center"><i class="icon-exclude f-20 vi-red-clr white-bg d-inline-block rounded-circle mr12"></i>Exclude Quick Mailing Group</div>
