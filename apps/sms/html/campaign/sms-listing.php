...
<div class="container-fluid p15 px-md30 py-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		...
		<div class="col-12 col-md-5 f-16 text-center text-md-right">
			<a href="javascript:void(0)" class="base-btn blue-btn mt10 mt-md0" data-toggle="modal" data-target="#createSMSModal"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New SMS</a>
		</div>
	</div>
	<!-- Header End  -->
	<div class="row">
		<div class="col-xl-2 col-lg-3 col-md-3 col-12">
			...
			<div class="nav flex-column nav-pills ui-vertical-tab f-16 w400">
				...
				<a class="nav-link active" href="sms-listing.php"><i class="icon-sms f-16"></i> SMS</a>
			</div>
		</div>
				...
				<div class="col-12 col-md-11 bs-h40 table-option-hide pl-md0 col-xl-width2">
					<div class="row">
						<div class="col-12 col-md-4 col-xl-2 mt15 mt-md0">
							<select class="selectpicker" title="All SMS (400)">
								<option>All SMS (400)</option>
								...
								<div class="col-12 col-md-8 col-lg-9 col-xl-10 mt15 mt-md0 d-flex flex-wrap pl-md5">
									<div class="row hide-edit-show no-gutters w-100">
										<div class="col-xl-6 col-lg-5 col-md-12 col-12 pr-md15">
											<div class="d-flex align-items-center">
												<div class="f-18 f-md-20 w500 text-ellipsis">SMS Name Goes Here </div><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-12"></i></a>
											</div>
										...
										<div class="col-xl-6 col-lg-7 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
											...
											<div class="d-flex justify-content-between flex-wrap w-100">
												...
												<div class="d-flex mr10">
													<div class="campaign-list-icon"><i class="icon-sent-sms"></i></div>
													<div class="ml10">
														<span class="f-15">Sent SMS</span>
														<div class="f-24 w700">50 </div>
													</div>
												</div>
												<div class="d-flex">
													<div class="campaign-list-icon"><i class="icon-clicked-sms"></i></div>
													<div class="ml10">
														<span class="f-15">Clicked SMS</span>
									...
									<div class="row edit-field-show no-gutters w-100">
										<div class="col-12 col-lg-11 col-xl-8 smart-form campaign-input-field">
											<div class="input-group">
												<input type="text" class="form-control field-h40 fw100 mb15 mb-md0" value="SMS Name Goes Here">
												<div class="input-group-append">
