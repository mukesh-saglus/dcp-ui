...
<div class="container-fluid p15 px-md30 py-md30">
	...
	<div class="row mb15 mb-md30 align-items-center">
		...
		<div class="col-12 col-md-5 f-16 text-center text-md-right">		
			<a href="javascript:void(0)" class="base-btn blue-btn mt10 mt-md0" data-toggle="modal" data-target="#createNewPageModal"><i class="icon-add-new f-18 align-middle"></i>&nbsp;&nbsp; New Video</a>
		</div>
	</div>
	<!-- Header End  -->
	<div class="row">
			...
			<div class="row">
				<div class="col-12 col-md-12 col-lg-8 order-2 order-lg-1 t-wauto tw-100 transition-all">
					<div class="col-12 project-list-view-border p0">
						...
						<!-- Error Message Div -->
					 <div class="video-corrupted-error">Corrupted video file, Processing aborted</div>
									...
									<div class="media">
										...
										<div class="media-body ml5">
											<div class="campaign-list-view">
												<img src="<?php echo $basedir; ?>images/corrupt-video-image.png" class="img-fluid">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="row hide-edit-show no-gutters w-100">
										<div class="col-xl-6 col-lg-5 col-md-12 col-12 pr-md15">
											<div class="d-flex align-items-center">
												<div class="f-18 f-md-20 w500 text-ellipsis">Video Name Goes Here </div><a href="#" class="ml8 d-gblue-clr t-decoration-none edit-link"><i class="icon-edit f-12"></i></a>
											</div>
											<div class="d-gblue-clr mb5">
												<p class="lh150 f-13">Created on Nov 18, 2017 at 4:08 PM</p>
											</div>
											<div class="d-flex align-items-center flex-wrap">
												<span class="f-12 campaign-list-private"><i class="icon-person f-10"></i> Private</span>
												<div class="mx20 video-social-icon-line"></div>
												<div class="d-flex align-items-center mr15 mr-md25 f-12 d-gblue-clr">
												<span class="video-like-comment-icon d-gblue-clr mr8"><i class="icon-Like f-11"></i></span>10
												</div>
												<div class="d-flex align-items-center f-12 d-gblue-clr">
												<span class="video-like-comment-icon d-gblue-clr mr8"><i class="icon-commentt f-11"></i></span>15
												</div>
											</div>
											<div class="mt15 f-13">Project Name : Project 2</div>
										...
										<div class="col-xl-6 col-lg-7 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
											...
											<div class="col-12 text-md-right p0 align-self-end">
												<ul class="list-inline w400 mb0">						
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal"><i class="icon-delete"></i><span class="hide-text-md">&nbsp;  Delete</span></a>
													</li>
								...
								<div class="col-12 col-md-8 col-lg-9 col-xl-10 mt15 mt-md0 d-flex flex-wrap pl-md5">
									<div class="row hide-edit-show no-gutters w-100">
										<div class="col-xl-6 col-lg-5 col-md-12 col-12 pr-md15">
											...
											<div class="d-flex align-items-center flex-wrap">
												<span class="f-12 campaign-list-active"><i class="icon-public f-10"></i> Public</span>
												<div class="mx20 video-social-icon-line"></div>
												<div class="d-flex align-items-center mr15 mr-md25 f-12 d-gblue-clr">
												<span class="video-like-comment-icon d-gblue-clr mr8"><i class="icon-Like f-11"></i></span>10
												</div>
										...
										<div class="col-xl-6 col-lg-7 col-md-12 col-12 mt15 mt-xl0 d-flex flex-wrap">
											...
											<div class="col-12 text-md-right p0 align-self-end">
												<ul class="list-inline w400 mb0">
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" title="Manage"><i class="icon-manage"></i><span class="hide-text-md">&nbsp;  Manage</span></a>
													</li>
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" title="View Reports"><i class="icon-report"></i><span class="hide-text-md">&nbsp;  View Reports</span></a>
													</li>
													<li class="list-inline-item mt10 mt-md15"><a href="#" class="base-btn default-btn list-btn-h25" title="Preview" data-toggle="modal" data-target="#videoModal"><i class="icon-preview"></i><span class="hide-text-md">&nbsp;  Preview</span></a>
													</li>
													<li class="list-inline-item mt10 mt-md15 dropdown simple-dropdown caret-icon-none">
														<a href="#" class="base-btn default-btn list-btn-h25 dropdown-toggle" data-toggle="dropdown">
															<span title="More" data-original-title="More"><i class=" icon-more"></i></span>
														</a>
								...
								<div class="col-12 col-md-8 col-lg-9 col-xl-10 mt15 mt-md0 d-flex flex-wrap pl-md5">
									<div class="row hide-edit-show no-gutters w-100">
										<div class="col-xl-6 col-lg-5 col-md-12 col-12 pr-md15">
											...
											<div class="d-flex align-items-center flex-wrap">
												<span class="f-12 campaign-list-scheduled"><i class="icon-locked f-10"></i>  Password protected</span>
												<div class="mx20 video-social-icon-line"></div>
												<div class="d-flex align-items-center mr15 mr-md25 f-12 d-gblue-clr">
												<span class="video-like-comment-icon d-gblue-clr mr8"><i class="icon-Like f-11"></i></span>10
												</div>
