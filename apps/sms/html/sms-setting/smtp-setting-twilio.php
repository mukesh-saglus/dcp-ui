            ...
            <div class="col-12 smart-form">
                <form>
                    <div class="row f-14">
                        ...
                        <div class="col-md-4 col-12 mb15 mb-md30">
                            <label class="d-gblue-clr">Account ID <span class="vi-red-clr">*</span> </label>
                            <input class="form-control f-14 field-h40" type="text" />
                        </div>

                        <div class="col-md-4 col-12 mb15 mb-md30">
                            <label class="d-gblue-clr">Token <span class="vi-red-clr">*</span></label>
                            <input class="form-control f-14 field-h40" type="text" />
                        </div>

                        <div class="col-md-8 col-12 mb15 mb-md30">
                            <label class="d-gblue-clr">Webhook URL <span class="vi-red-clr">*</span></label>
                            <input class="form-control f-14 field-h40" type="text" value="https://dotcompal.com/tracking/twilio-events" disabled />
                        </div>
                    </div>
                </form>
            </div>
