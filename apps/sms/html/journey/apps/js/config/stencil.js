...
(function() {
    ...
    App.config.stencil.shapes.standard = [
		...
		
		{
            ...
            markup: "<g class='rotatable action-modal' stencil-type='sms'><g class='show-block'><rect class='trigger-stencil'/><image class='icon contact-element-icon'></image><text class='stencil-label'/></g><g class='hide-block'><rect class='trigger-header'/><text class='trigger-header-text'/><image class='icon trigger-edit' xlink:href='images/editor/action/edit-icon.svg' data-tooltip='Edit'></image><line class='action-line' transform='translate(171, 18)'></line><image class='icon trigger-view' xlink:href='images/editor/action/view-icon.svg' data-tooltip='Preview'></image><line class='action-line' transform='translate(201, 18)'></line><image class='icon trigger-delete' event='element:delete' xlink:href='images/editor/delete-icon.svg' data-tooltip='Delete'></image><rect class='trigger-body-text' /><text class='trigger-body-content' data-toggle='modal' data-target='#SMSModal'/><circle class='trigger-circle'/><image class='icon trigger-icon'></image><circle class='trigger-connect-circle'/><image class='icon trigger-connect-icon' xlink:href='images/editor/next-icon.svg'></image></g></g>",
            // allowOrthogonalResize: false,
            ...
            attrs: {
                ...
                ".contact-element-icon": {
                    ...
                    height: 28,
                    r: 10,
                    xlinkHref: 'images/editor/trigger/sms-icon.svg',
                },
                ".stencil-label": {
                ...
                ".trigger-icon": {
                    ...
                    height: 21,
                    r: 26,
                    xlinkHref: 'images/editor/trigger/sms-drag-icon.svg',
                },
                ".trigger-connect-circle": {
                    transform: "translate(202, 25)",
                    r: 15,
                ...
                items: [
                    {
                        ...
                        attrs: {
                            ...
                            poetImage: {
                                ...
                                xlinkHref: 'images/editor/trigger/sms-on-send-icon.svg',
                                height: 9,
                                width: 8,
                            },
                            portText: {
                    ...
                    },
                    {
                        ...
                        attrs: {
                            ...
                            poetImage: {
                                ...
                                xlinkHref: 'images/editor/trigger/sms-on-open-icon.svg',
                                height: 8,
                                width: 8,
                            },
                            portText: {
                    ...
                    },
                    {
                        ...
                        attrs: {
                            ...
                            poetImage: {
                                ...
                                xlinkHref: 'images/editor/trigger/sms-on-click-icon.svg',
                                height: 8,
                                width: 8,
                            },
                            portText: {
    ...
    App.config.stencil.shapes.fsa = [
        ...
        },
		{
            ...
            markup: "<g class='rotatable action-modal' stencil-type='sendsms'><g class='show-block'><rect class='action-stencil'/><image class='icon contact-element-icon'></image><text class='stencil-label'/></g><g class='hide-block' magnet='passive'><rect class='trigger-paper'/><rect class='trigger-header'/><text class='trigger-header-text'/><image class='icon trigger-edit' xlink:href='images/editor/action/edit-icon.svg' data-tooltip='Edit'></image><line class='action-line' transform='translate(171, 18)'></line><image class='icon trigger-view' xlink:href='images/editor/action/view-icon.svg' data-tooltip='Preview'></image><line class='action-line' transform='translate(201, 18)'></line><image class='icon trigger-delete' event='element:delete' xlink:href='images/editor/delete-icon.svg' data-tooltip='Delete'></image><rect class='trigger-body-text' /><text class='trigger-body-content'  data-toggle='modal' data-target='#SMSDesignSelectionModal'/><circle class='trigger-circle'/><image class='icon trigger-icon'></image><circle class='trigger-connect-circle'/><image class='icon trigger-connect-icon' xlink:href='images/editor/next-icon-white.svg'></image></g></g>",
            // allowOrthogonalResize: false,

            attrs: {
                root: {
                    dataTooltip: 'Send SMS',
                    dataTooltipPosition: 'left',
                    dataTooltipPositionSelector: '.joint-stencil'
                },
                ".action-stencil": {
				...
				".contact-element-icon": {
                    ...
                    height: 26,
                    r: 10,
                    xlinkHref: 'images/editor/action/send-sms-icon.svg',
                },
                ".stencil-label": {
                    transform: "translate(2, 75)",
                    text: 'Send SMS'
                ...
                ".trigger-icon": {
                    ...
                    height: 21,
                    r: 26,
                    xlinkHref: 'images/editor/action/send-sms-drag-icon.svg',
                },
                ".trigger-connect-circle": {
                    transform: "translate(202, 25)",
                    r: 15,
